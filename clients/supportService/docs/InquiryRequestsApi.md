...
> models::InquiryRequestDtoListEnvelope get_inquiry_requests_async(tenant_id, api_version, x_api_version, inquiry_request_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**inquiry_request_dto_collection_query_parameters** | Option<[**InquiryRequestDtoCollectionQueryParameters**](InquiryRequestDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_inquiry_requests_count_async(tenant_id, api_version, x_api_version, inquiry_request_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_inquiry_request_async(tenant_id, inquiry_request_id, api_version, x_api_version, patch_operation)
