...
> models::ItemRefundPolicyDtoListEnvelope get_refund_policies_async(tenant_id, api_version, x_api_version, item_refund_policy_dto_collection_query_parameters)
...
> models::Int32Envelope get_refund_policies_count_async(tenant_id, api_version, x_api_version, item_refund_policy_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_refund_policy_async(tenant_id, refund_policy_id, api_version, x_api_version, patch_operation)
