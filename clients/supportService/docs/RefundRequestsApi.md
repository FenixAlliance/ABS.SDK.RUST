...
> models::RefundRequestDtoListEnvelope get_refund_requests_async(tenant_id, api_version, x_api_version, refund_request_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**refund_request_dto_collection_query_parameters** | Option<[**RefundRequestDtoCollectionQueryParameters**](RefundRequestDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_refund_requests_count_async(tenant_id, api_version, x_api_version, refund_request_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_refund_request_async(tenant_id, refund_request_id, api_version, x_api_version, patch_operation)
