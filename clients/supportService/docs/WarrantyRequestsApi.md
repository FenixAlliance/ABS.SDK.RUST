...
> models::WarrantyRequestDtoListEnvelope get_warranty_requests_async(tenant_id, api_version, x_api_version, warranty_request_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**warranty_request_dto_collection_query_parameters** | Option<[**WarrantyRequestDtoCollectionQueryParameters**](WarrantyRequestDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_warranty_requests_count_async(tenant_id, api_version, x_api_version, warranty_request_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_warranty_request_async(tenant_id, warranty_request_id, api_version, x_api_version, patch_operation)
