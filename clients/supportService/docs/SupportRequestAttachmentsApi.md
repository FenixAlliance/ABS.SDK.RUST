...
> models::SupportRequestAttachmentDtoListEnvelope get_support_request_attachments_async(tenant_id, api_version, x_api_version, support_request_attachment_dto_collection_query_parameters)
...
> models::Int32Envelope get_support_request_attachments_count_async(tenant_id, api_version, x_api_version, support_request_attachment_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_support_request_attachment_async(tenant_id, support_request_attachment_id, api_version, x_api_version, patch_operation)
