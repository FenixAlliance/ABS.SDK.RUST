...
pub struct SupportTicketDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportTicketDto>>>,
}

impl SupportTicketDtoListEnvelope {
    pub fn new() -> SupportTicketDtoListEnvelope {
