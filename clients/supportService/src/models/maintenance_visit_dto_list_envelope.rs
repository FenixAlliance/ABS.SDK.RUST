...
pub struct MaintenanceVisitDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::MaintenanceVisitDto>>>,
}

impl MaintenanceVisitDtoListEnvelope {
    pub fn new() -> MaintenanceVisitDtoListEnvelope {
