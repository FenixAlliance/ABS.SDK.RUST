...
pub struct KnowledgeArticleDtoEnvelope {
    ...
    pub result: Option<Box<models::KnowledgeArticleDto>>,
}

impl KnowledgeArticleDtoEnvelope {
    pub fn new() -> KnowledgeArticleDtoEnvelope {
