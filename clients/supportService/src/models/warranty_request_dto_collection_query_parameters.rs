...
pub struct WarrantyRequestDtoCollectionQueryParameters {
...
impl WarrantyRequestDtoCollectionQueryParameters {
    pub fn new() -> WarrantyRequestDtoCollectionQueryParameters {
