...
pub struct RefundRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::RefundRequestDto>>>,
}

impl RefundRequestDtoListEnvelope {
    pub fn new() -> RefundRequestDtoListEnvelope {
