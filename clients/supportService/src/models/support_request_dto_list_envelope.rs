...
pub struct SupportRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportRequestDto>>>,
}

impl SupportRequestDtoListEnvelope {
    pub fn new() -> SupportRequestDtoListEnvelope {
