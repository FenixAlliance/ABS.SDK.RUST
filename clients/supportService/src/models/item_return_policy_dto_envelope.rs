...
pub struct ItemReturnPolicyDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemReturnPolicyDto>>,
}

impl ItemReturnPolicyDtoEnvelope {
    pub fn new() -> ItemReturnPolicyDtoEnvelope {
