...
pub struct SupportTicketConversationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportTicketConversationDto>>>,
}

impl SupportTicketConversationDtoListEnvelope {
    pub fn new() -> SupportTicketConversationDtoListEnvelope {
