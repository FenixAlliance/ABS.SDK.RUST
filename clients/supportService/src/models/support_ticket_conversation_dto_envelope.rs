...
pub struct SupportTicketConversationDtoEnvelope {
    ...
    pub result: Option<Box<models::SupportTicketConversationDto>>,
}

impl SupportTicketConversationDtoEnvelope {
    pub fn new() -> SupportTicketConversationDtoEnvelope {
