...
pub struct SupportRequestAttachmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportRequestAttachmentDto>>>,
}

impl SupportRequestAttachmentDtoListEnvelope {
    pub fn new() -> SupportRequestAttachmentDtoListEnvelope {
