...
pub struct WarrantyRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WarrantyRequestDto>>>,
}

impl WarrantyRequestDtoListEnvelope {
    pub fn new() -> WarrantyRequestDtoListEnvelope {
