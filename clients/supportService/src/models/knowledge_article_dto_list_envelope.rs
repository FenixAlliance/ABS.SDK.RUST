...
pub struct KnowledgeArticleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::KnowledgeArticleDto>>>,
}

impl KnowledgeArticleDtoListEnvelope {
    pub fn new() -> KnowledgeArticleDtoListEnvelope {
