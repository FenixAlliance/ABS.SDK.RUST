...
pub struct WarrantyRequestDtoEnvelope {
    ...
    pub result: Option<Box<models::WarrantyRequestDto>>,
}

impl WarrantyRequestDtoEnvelope {
    pub fn new() -> WarrantyRequestDtoEnvelope {
