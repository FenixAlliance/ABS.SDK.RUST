...
pub struct SupportTicketTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportTicketTypeDto>>>,
}

impl SupportTicketTypeDtoListEnvelope {
    pub fn new() -> SupportTicketTypeDtoListEnvelope {
