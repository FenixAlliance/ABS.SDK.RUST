...
pub struct ReturnRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ReturnRequestDto>>>,
}

impl ReturnRequestDtoListEnvelope {
    pub fn new() -> ReturnRequestDtoListEnvelope {
