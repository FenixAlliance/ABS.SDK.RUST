...
pub struct RefundRequestDtoCollectionQueryParameters {
...
impl RefundRequestDtoCollectionQueryParameters {
    pub fn new() -> RefundRequestDtoCollectionQueryParameters {
