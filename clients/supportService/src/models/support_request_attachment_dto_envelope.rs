...
pub struct SupportRequestAttachmentDtoEnvelope {
    ...
    pub result: Option<Box<models::SupportRequestAttachmentDto>>,
}

impl SupportRequestAttachmentDtoEnvelope {
    pub fn new() -> SupportRequestAttachmentDtoEnvelope {
