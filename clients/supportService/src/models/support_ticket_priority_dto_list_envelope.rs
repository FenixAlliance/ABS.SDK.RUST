...
pub struct SupportTicketPriorityDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportTicketPriorityDto>>>,
}

impl SupportTicketPriorityDtoListEnvelope {
    pub fn new() -> SupportTicketPriorityDtoListEnvelope {
