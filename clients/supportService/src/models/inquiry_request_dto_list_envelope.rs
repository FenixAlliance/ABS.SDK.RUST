...
pub struct InquiryRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InquiryRequestDto>>>,
}

impl InquiryRequestDtoListEnvelope {
    pub fn new() -> InquiryRequestDtoListEnvelope {
