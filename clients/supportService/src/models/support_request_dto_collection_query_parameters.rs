...
pub struct SupportRequestDtoCollectionQueryParameters {
...
impl SupportRequestDtoCollectionQueryParameters {
    pub fn new() -> SupportRequestDtoCollectionQueryParameters {
