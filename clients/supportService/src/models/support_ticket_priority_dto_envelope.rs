...
pub struct SupportTicketPriorityDtoEnvelope {
    ...
    pub result: Option<Box<models::SupportTicketPriorityDto>>,
}

impl SupportTicketPriorityDtoEnvelope {
    pub fn new() -> SupportTicketPriorityDtoEnvelope {
