...
pub struct MaintenanceVisitDtoCollectionQueryParameters {
...
impl MaintenanceVisitDtoCollectionQueryParameters {
    pub fn new() -> MaintenanceVisitDtoCollectionQueryParameters {
