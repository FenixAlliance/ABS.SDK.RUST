...
pub struct SupportEntitlementDtoEnvelope {
    ...
    pub result: Option<Box<models::SupportEntitlementDto>>,
}

impl SupportEntitlementDtoEnvelope {
    pub fn new() -> SupportEntitlementDtoEnvelope {
