...
pub struct InquiryRequestDtoCollectionQueryParameters {
...
impl InquiryRequestDtoCollectionQueryParameters {
    pub fn new() -> InquiryRequestDtoCollectionQueryParameters {
