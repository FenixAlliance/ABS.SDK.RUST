...
pub struct SupportEntitlementDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupportEntitlementDto>>>,
}

impl SupportEntitlementDtoListEnvelope {
    pub fn new() -> SupportEntitlementDtoListEnvelope {
