...
pub struct MaintenanceVisitDtoEnvelope {
    ...
    pub result: Option<Box<models::MaintenanceVisitDto>>,
}

impl MaintenanceVisitDtoEnvelope {
    pub fn new() -> MaintenanceVisitDtoEnvelope {
