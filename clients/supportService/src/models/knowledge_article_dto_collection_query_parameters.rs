...
pub struct KnowledgeArticleDtoCollectionQueryParameters {
...
impl KnowledgeArticleDtoCollectionQueryParameters {
    pub fn new() -> KnowledgeArticleDtoCollectionQueryParameters {
