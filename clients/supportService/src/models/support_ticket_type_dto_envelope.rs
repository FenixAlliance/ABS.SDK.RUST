...
pub struct SupportTicketTypeDtoEnvelope {
    ...
    pub result: Option<Box<models::SupportTicketTypeDto>>,
}

impl SupportTicketTypeDtoEnvelope {
    pub fn new() -> SupportTicketTypeDtoEnvelope {
