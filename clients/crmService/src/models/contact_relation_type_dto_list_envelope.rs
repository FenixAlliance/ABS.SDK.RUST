...
pub struct ContactRelationTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactRelationTypeDto>>>,
}

impl ContactRelationTypeDtoListEnvelope {
    pub fn new() -> ContactRelationTypeDtoListEnvelope {
