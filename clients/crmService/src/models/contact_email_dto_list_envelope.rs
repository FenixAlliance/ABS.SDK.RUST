...
pub struct ContactEmailDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactEmailDto>>>,
}

impl ContactEmailDtoListEnvelope {
    pub fn new() -> ContactEmailDtoListEnvelope {
