...
pub struct ContactSourceDtoCollectionQueryParameters {
...
impl ContactSourceDtoCollectionQueryParameters {
    pub fn new() -> ContactSourceDtoCollectionQueryParameters {
