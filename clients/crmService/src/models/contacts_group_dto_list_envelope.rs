...
pub struct ContactsGroupDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactsGroupDto>>>,
}

impl ContactsGroupDtoListEnvelope {
    pub fn new() -> ContactsGroupDtoListEnvelope {
