...
pub struct ContactRelationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactRelationDto>>>,
}

impl ContactRelationDtoListEnvelope {
    pub fn new() -> ContactRelationDtoListEnvelope {
