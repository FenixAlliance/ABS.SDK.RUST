...
pub struct ContactProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactProfileDto>>>,
}

impl ContactProfileDtoListEnvelope {
    pub fn new() -> ContactProfileDtoListEnvelope {
