...
pub struct ExtendedContactDtoCollectionQueryParameters {
...
impl ExtendedContactDtoCollectionQueryParameters {
    pub fn new() -> ExtendedContactDtoCollectionQueryParameters {
