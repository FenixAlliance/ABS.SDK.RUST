...
pub struct ContactSourceDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ContactSourceDto>>>,
}

impl ContactSourceDtoListEnvelope {
    pub fn new() -> ContactSourceDtoListEnvelope {
