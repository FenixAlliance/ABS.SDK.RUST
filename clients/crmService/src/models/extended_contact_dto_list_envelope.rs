...
pub struct ExtendedContactDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedContactDto>>>,
}

impl ExtendedContactDtoListEnvelope {
    pub fn new() -> ExtendedContactDtoListEnvelope {
