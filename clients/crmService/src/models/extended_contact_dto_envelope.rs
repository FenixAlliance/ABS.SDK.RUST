...
pub struct ExtendedContactDtoEnvelope {
    ...
    pub result: Option<Box<models::ExtendedContactDto>>,
}

impl ExtendedContactDtoEnvelope {
    pub fn new() -> ExtendedContactDtoEnvelope {
