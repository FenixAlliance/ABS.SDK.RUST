...
> models::ContactRelationTypeDtoListEnvelope get_contact_relation_types_async(tenant_id, api_version, x_api_version, contact_relation_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**contact_relation_type_dto_collection_query_parameters** | Option<[**ContactRelationTypeDtoCollectionQueryParameters**](ContactRelationTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_contact_relation_types_count_async(tenant_id, api_version, x_api_version, contact_relation_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_contact_relation_type_async(tenant_id, id, api_version, x_api_version, patch_operation)
