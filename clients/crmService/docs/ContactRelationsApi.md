...
> models::ContactRelationDtoListEnvelope get_contact_relations_async(tenant_id, api_version, x_api_version)
...
> models::Int32Envelope get_contact_relations_count_async(tenant_id, api_version, x_api_version)
...
> models::EmptyEnvelope patch_contact_relation_async(tenant_id, id, api_version, x_api_version, operation)
