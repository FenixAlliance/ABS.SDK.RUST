...
> models::ContactSourceDtoListEnvelope get_contact_sources_async(tenant_id, api_version, x_api_version)
...
> models::Int32Envelope get_contact_sources_count_async(tenant_id, api_version, x_api_version)
...
> models::EmptyEnvelope patch_contact_source_async(tenant_id, id, api_version, x_api_version, operation)
