...
> models::TenantDepartmentDtoListEnvelope get_tenant_departments(tenant_id, api_version, x_api_version, tenant_department_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_department_dto_collection_query_parameters** | Option<[**TenantDepartmentDtoCollectionQueryParameters**](TenantDepartmentDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_departments_count(tenant_id, api_version, x_api_version, tenant_department_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_department_async(tenant_id, tenant_department_id, api_version, x_api_version, patch_operation)
