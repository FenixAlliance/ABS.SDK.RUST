...
> models::TenantPositionDtoListEnvelope get_tenant_positions(tenant_id, api_version, x_api_version, tenant_position_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_position_dto_collection_query_parameters** | Option<[**TenantPositionDtoCollectionQueryParameters**](TenantPositionDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_positions_count(tenant_id, api_version, x_api_version, tenant_position_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_position(tenant_id, tenant_position_id, api_version, x_api_version, patch_operation)
