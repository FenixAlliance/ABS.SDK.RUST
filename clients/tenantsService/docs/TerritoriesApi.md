...
> models::TenantTerritoryDtoListEnvelope get_tenant_territories(tenant_id, api_version, x_api_version, tenant_territory_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_territory_dto_collection_query_parameters** | Option<[**TenantTerritoryDtoCollectionQueryParameters**](TenantTerritoryDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_territories_count(tenant_id, api_version, x_api_version, tenant_territory_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_territory(tenant_id, tenant_territory_id, api_version, x_api_version, patch_operation)
