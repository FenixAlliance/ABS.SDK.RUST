...
> models::TenantTypeDtoListEnvelope get_tenant_types(tenant_id, api_version, x_api_version, tenant_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_type_dto_collection_query_parameters** | Option<[**TenantTypeDtoCollectionQueryParameters**](TenantTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_types_count(tenant_id, api_version, x_api_version, tenant_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_type(tenant_id, tenant_type_id, api_version, x_api_version, patch_operation)
Patch a tenant type
