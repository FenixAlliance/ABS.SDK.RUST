...
> models::TenantSegmentDtoListEnvelope get_tenant_segments(tenant_id, api_version, x_api_version, tenant_segment_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_segment_dto_collection_query_parameters** | Option<[**TenantSegmentDtoCollectionQueryParameters**](TenantSegmentDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_segments_count(tenant_id, api_version, x_api_version, tenant_segment_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_segment(tenant_id, tenant_segment_id, api_version, x_api_version, patch_operation)
