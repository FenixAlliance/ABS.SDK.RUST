...
> models::TenantSizeDtoListEnvelope get_tenant_sizes(tenant_id, api_version, x_api_version, tenant_size_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tenant_size_dto_collection_query_parameters** | Option<[**TenantSizeDtoCollectionQueryParameters**](TenantSizeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tenant_sizes_count(tenant_id, api_version, x_api_version, tenant_size_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_tenant_size(tenant_id, tenant_size_id, api_version, x_api_version, patch_operation)
Patch a tenant size
