...
pub struct TenantIndustryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantIndustryDto>>>,
}

impl TenantIndustryDtoListEnvelope {
    pub fn new() -> TenantIndustryDtoListEnvelope {
