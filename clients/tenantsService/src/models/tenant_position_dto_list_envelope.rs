...
pub struct TenantPositionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantPositionDto>>>,
}

impl TenantPositionDtoListEnvelope {
    pub fn new() -> TenantPositionDtoListEnvelope {
