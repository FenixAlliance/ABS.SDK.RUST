...
pub struct TenantTeamEmployeeEnrollmentDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantTeamEmployeeEnrollmentDto>>,
}

impl TenantTeamEmployeeEnrollmentDtoEnvelope {
    pub fn new() -> TenantTeamEmployeeEnrollmentDtoEnvelope {
