...
pub struct TenantUnitDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantUnitDto>>>,
}

impl TenantUnitDtoListEnvelope {
    pub fn new() -> TenantUnitDtoListEnvelope {
