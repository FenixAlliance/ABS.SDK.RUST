...
pub struct TenantTerritoryDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantTerritoryDto>>,
}

impl TenantTerritoryDtoEnvelope {
    pub fn new() -> TenantTerritoryDtoEnvelope {
