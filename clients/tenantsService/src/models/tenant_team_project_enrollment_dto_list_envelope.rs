...
pub struct TenantTeamProjectEnrollmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTeamProjectEnrollmentDto>>>,
}

impl TenantTeamProjectEnrollmentDtoListEnvelope {
    pub fn new() -> TenantTeamProjectEnrollmentDtoListEnvelope {
