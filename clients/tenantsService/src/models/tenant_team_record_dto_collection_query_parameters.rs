...
pub struct TenantTeamRecordDtoCollectionQueryParameters {
...
impl TenantTeamRecordDtoCollectionQueryParameters {
    pub fn new() -> TenantTeamRecordDtoCollectionQueryParameters {
