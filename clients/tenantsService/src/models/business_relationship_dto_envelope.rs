...
pub struct BusinessRelationshipDtoEnvelope {
    ...
    pub result: Option<Box<models::BusinessRelationshipDto>>,
}

impl BusinessRelationshipDtoEnvelope {
    pub fn new() -> BusinessRelationshipDtoEnvelope {
