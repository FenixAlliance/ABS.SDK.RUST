...
pub struct TenantTeamRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTeamRecordDto>>>,
}

impl TenantTeamRecordDtoListEnvelope {
    pub fn new() -> TenantTeamRecordDtoListEnvelope {
