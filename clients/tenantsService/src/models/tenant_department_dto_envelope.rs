...
pub struct TenantDepartmentDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantDepartmentDto>>,
}

impl TenantDepartmentDtoEnvelope {
    pub fn new() -> TenantDepartmentDtoEnvelope {
