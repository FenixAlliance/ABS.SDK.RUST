...
pub struct BusinessRelationshipDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BusinessRelationshipDto>>>,
}

impl BusinessRelationshipDtoListEnvelope {
    pub fn new() -> BusinessRelationshipDtoListEnvelope {
