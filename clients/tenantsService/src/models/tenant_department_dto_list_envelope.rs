...
pub struct TenantDepartmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantDepartmentDto>>>,
}

impl TenantDepartmentDtoListEnvelope {
    pub fn new() -> TenantDepartmentDtoListEnvelope {
