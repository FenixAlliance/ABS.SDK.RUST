...
pub struct TenantInvitationDtoCollectionQueryParameters {
...
impl TenantInvitationDtoCollectionQueryParameters {
    pub fn new() -> TenantInvitationDtoCollectionQueryParameters {
