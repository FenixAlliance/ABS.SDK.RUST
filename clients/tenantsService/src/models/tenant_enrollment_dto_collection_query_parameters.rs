...
pub struct TenantEnrollmentDtoCollectionQueryParameters {
...
impl TenantEnrollmentDtoCollectionQueryParameters {
    pub fn new() -> TenantEnrollmentDtoCollectionQueryParameters {
