...
pub struct TenantInvitationDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantInvitationDto>>,
}

impl TenantInvitationDtoEnvelope {
    pub fn new() -> TenantInvitationDtoEnvelope {
