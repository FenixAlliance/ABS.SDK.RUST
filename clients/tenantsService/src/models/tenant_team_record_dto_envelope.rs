...
pub struct TenantTeamRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantTeamRecordDto>>,
}

impl TenantTeamRecordDtoEnvelope {
    pub fn new() -> TenantTeamRecordDtoEnvelope {
