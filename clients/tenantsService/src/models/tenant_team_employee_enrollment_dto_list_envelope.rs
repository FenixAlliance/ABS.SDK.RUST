...
pub struct TenantTeamEmployeeEnrollmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTeamEmployeeEnrollmentDto>>>,
}

impl TenantTeamEmployeeEnrollmentDtoListEnvelope {
    pub fn new() -> TenantTeamEmployeeEnrollmentDtoListEnvelope {
