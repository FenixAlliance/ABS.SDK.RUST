...
pub struct TenantSizeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantSizeDto>>>,
}

impl TenantSizeDtoListEnvelope {
    pub fn new() -> TenantSizeDtoListEnvelope {
