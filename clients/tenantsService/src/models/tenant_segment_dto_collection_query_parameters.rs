...
pub struct TenantSegmentDtoCollectionQueryParameters {
...
impl TenantSegmentDtoCollectionQueryParameters {
    pub fn new() -> TenantSegmentDtoCollectionQueryParameters {
