...
pub struct SuiteLicenseFeatureDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SuiteLicenseFeatureDto>>>,
}

impl SuiteLicenseFeatureDtoListEnvelope {
    pub fn new() -> SuiteLicenseFeatureDtoListEnvelope {
