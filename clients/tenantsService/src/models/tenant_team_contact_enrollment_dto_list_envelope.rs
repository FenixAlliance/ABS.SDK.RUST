...
pub struct TenantTeamContactEnrollmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTeamContactEnrollmentDto>>>,
}

impl TenantTeamContactEnrollmentDtoListEnvelope {
    pub fn new() -> TenantTeamContactEnrollmentDtoListEnvelope {
