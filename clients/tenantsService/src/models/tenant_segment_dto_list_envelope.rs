...
pub struct TenantSegmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantSegmentDto>>>,
}

impl TenantSegmentDtoListEnvelope {
    pub fn new() -> TenantSegmentDtoListEnvelope {
