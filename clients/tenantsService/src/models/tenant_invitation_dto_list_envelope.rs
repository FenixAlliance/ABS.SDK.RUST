...
pub struct TenantInvitationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantInvitationDto>>>,
}

impl TenantInvitationDtoListEnvelope {
    pub fn new() -> TenantInvitationDtoListEnvelope {
