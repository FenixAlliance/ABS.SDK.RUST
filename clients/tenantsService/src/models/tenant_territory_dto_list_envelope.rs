...
pub struct TenantTerritoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTerritoryDto>>>,
}

impl TenantTerritoryDtoListEnvelope {
    pub fn new() -> TenantTerritoryDtoListEnvelope {
