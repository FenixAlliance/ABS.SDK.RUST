...
pub struct TenantTeamProjectEnrollmentDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantTeamProjectEnrollmentDto>>,
}

impl TenantTeamProjectEnrollmentDtoEnvelope {
    pub fn new() -> TenantTeamProjectEnrollmentDtoEnvelope {
