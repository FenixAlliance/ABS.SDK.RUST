...
pub struct ExtendedTenantEnrollmentDtoEnvelope {
    ...
    pub result: Option<Box<models::ExtendedTenantEnrollmentDto>>,
}

impl ExtendedTenantEnrollmentDtoEnvelope {
    pub fn new() -> ExtendedTenantEnrollmentDtoEnvelope {
