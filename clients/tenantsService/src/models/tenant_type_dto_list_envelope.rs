...
pub struct TenantTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTypeDto>>>,
}

impl TenantTypeDtoListEnvelope {
    pub fn new() -> TenantTypeDtoListEnvelope {
