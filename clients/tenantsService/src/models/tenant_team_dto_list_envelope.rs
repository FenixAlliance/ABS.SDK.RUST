...
pub struct TenantTeamDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantTeamDto>>>,
}

impl TenantTeamDtoListEnvelope {
    pub fn new() -> TenantTeamDtoListEnvelope {
