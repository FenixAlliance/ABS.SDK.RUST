...
pub struct TenantTeamContactEnrollmentDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantTeamContactEnrollmentDto>>,
}

impl TenantTeamContactEnrollmentDtoEnvelope {
    pub fn new() -> TenantTeamContactEnrollmentDtoEnvelope {
