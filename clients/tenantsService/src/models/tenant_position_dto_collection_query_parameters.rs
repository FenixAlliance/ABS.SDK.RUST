...
pub struct TenantPositionDtoCollectionQueryParameters {
...
impl TenantPositionDtoCollectionQueryParameters {
    pub fn new() -> TenantPositionDtoCollectionQueryParameters {
