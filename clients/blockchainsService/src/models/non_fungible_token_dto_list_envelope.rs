...
pub struct NonFungibleTokenDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::NonFungibleTokenDto>>>,
}

impl NonFungibleTokenDtoListEnvelope {
    pub fn new() -> NonFungibleTokenDtoListEnvelope {
