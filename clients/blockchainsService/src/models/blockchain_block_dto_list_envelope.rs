...
pub struct BlockchainBlockDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlockchainBlockDto>>>,
}

impl BlockchainBlockDtoListEnvelope {
    pub fn new() -> BlockchainBlockDtoListEnvelope {
