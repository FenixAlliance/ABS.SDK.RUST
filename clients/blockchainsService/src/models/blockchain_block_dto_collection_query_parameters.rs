...
pub struct BlockchainBlockDtoCollectionQueryParameters {
...
impl BlockchainBlockDtoCollectionQueryParameters {
    pub fn new() -> BlockchainBlockDtoCollectionQueryParameters {
