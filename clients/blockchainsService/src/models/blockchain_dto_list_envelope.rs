...
pub struct BlockchainDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlockchainDto>>>,
}

impl BlockchainDtoListEnvelope {
    pub fn new() -> BlockchainDtoListEnvelope {
