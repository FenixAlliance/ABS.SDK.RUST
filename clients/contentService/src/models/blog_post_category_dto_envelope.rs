...
pub struct BlogPostCategoryDtoEnvelope {
    ...
    pub result: Option<Box<models::BlogPostCategoryDto>>,
}

impl BlogPostCategoryDtoEnvelope {
    pub fn new() -> BlogPostCategoryDtoEnvelope {
