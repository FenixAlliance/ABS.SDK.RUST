...
pub struct WebPageCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebPageCategoryDto>>>,
}

impl WebPageCategoryDtoListEnvelope {
    pub fn new() -> WebPageCategoryDtoListEnvelope {
