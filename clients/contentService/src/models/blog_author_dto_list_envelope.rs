...
pub struct BlogAuthorDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlogAuthorDto>>>,
}

impl BlogAuthorDtoListEnvelope {
    pub fn new() -> BlogAuthorDtoListEnvelope {
