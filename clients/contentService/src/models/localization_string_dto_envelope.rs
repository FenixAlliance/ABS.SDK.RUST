...
pub struct LocalizationStringDtoEnvelope {
    ...
    pub result: Option<Box<models::LocalizationStringDto>>,
}

impl LocalizationStringDtoEnvelope {
    pub fn new() -> LocalizationStringDtoEnvelope {
