...
pub struct WebTemplateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebTemplateDto>>>,
}

impl WebTemplateDtoListEnvelope {
    pub fn new() -> WebTemplateDtoListEnvelope {
