...
pub struct BlogPostTagDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlogPostTagDto>>>,
}

impl BlogPostTagDtoListEnvelope {
    pub fn new() -> BlogPostTagDtoListEnvelope {
