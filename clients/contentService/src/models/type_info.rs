...
pub struct TypeInfo {
    ...
    pub declaring_method: Option<Box<models::MethodBase>>,
    ...
    pub underlying_system_type: Option<Box<models::Type>>,
    ...
    #[serde(rename = "isFunctionPointer", skip_serializing_if = "Option::is_none")]
    pub is_function_pointer: Option<bool>,
    #[serde(rename = "isUnmanagedFunctionPointer", skip_serializing_if = "Option::is_none")]
    pub is_unmanaged_function_pointer: Option<bool>,
    #[serde(rename = "hasElementType", skip_serializing_if = "Option::is_none")]
    pub has_element_type: Option<bool>,
    #[serde(rename = "genericTypeArguments", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub generic_type_arguments: Option<Option<Vec<models::Type>>>,
    ...
    pub generic_parameter_attributes: Option<GenericParameterAttributes>,
    ...
    pub struct_layout_attribute: Option<Box<models::StructLayoutAttribute>>,
    #[serde(rename = "typeInitializer", skip_serializing_if = "Option::is_none")]
    pub type_initializer: Option<Box<models::ConstructorInfo>>,
    #[serde(rename = "typeHandle", skip_serializing_if = "Option::is_none")]
    pub type_handle: Option<Box<models::RuntimeTypeHandle>>,
    ...
    pub base_type: Option<Box<models::Type>>,
    ...
    #[serde(rename = "genericTypeParameters", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub generic_type_parameters: Option<Option<Vec<models::Type>>>,
    #[serde(rename = "declaredConstructors", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_constructors: Option<Option<Vec<models::ConstructorInfo>>>,
    #[serde(rename = "declaredEvents", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_events: Option<Option<Vec<models::EventInfo>>>,
    #[serde(rename = "declaredFields", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_fields: Option<Option<Vec<models::FieldInfo>>>,
    #[serde(rename = "declaredMembers", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_members: Option<Option<Vec<models::MemberInfo>>>,
    #[serde(rename = "declaredMethods", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_methods: Option<Option<Vec<models::MethodInfo>>>,
    #[serde(rename = "declaredNestedTypes", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_nested_types: Option<Option<Vec<models::TypeInfo>>>,
    #[serde(rename = "declaredProperties", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub declared_properties: Option<Option<Vec<models::PropertyInfo>>>,
    #[serde(rename = "implementedInterfaces", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub implemented_interfaces: Option<Option<Vec<models::Type>>>,
}
...
impl TypeInfo {
    pub fn new() -> TypeInfo {
        TypeInfo {
            ...
            is_by_ref_like: None,
            is_function_pointer: None,
            is_unmanaged_function_pointer: None,
