...
pub struct BlogPostCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlogPostCategoryDto>>>,
}

impl BlogPostCategoryDtoListEnvelope {
    pub fn new() -> BlogPostCategoryDtoListEnvelope {
