...
pub struct BlogPostCommentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BlogPostCommentDto>>>,
}

impl BlogPostCommentDtoListEnvelope {
    pub fn new() -> BlogPostCommentDtoListEnvelope {
