...
pub struct WebContentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebContentDto>>>,
}

impl WebContentDtoListEnvelope {
    pub fn new() -> WebContentDtoListEnvelope {
