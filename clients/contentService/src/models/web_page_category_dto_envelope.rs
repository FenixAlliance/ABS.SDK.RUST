...
pub struct WebPageCategoryDtoEnvelope {
    ...
    pub result: Option<Box<models::WebPageCategoryDto>>,
}

impl WebPageCategoryDtoEnvelope {
    pub fn new() -> WebPageCategoryDtoEnvelope {
