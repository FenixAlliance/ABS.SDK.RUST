...
pub struct BusinessDomainDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BusinessDomainDto>>>,
}

impl BusinessDomainDtoListEnvelope {
    pub fn new() -> BusinessDomainDtoListEnvelope {
