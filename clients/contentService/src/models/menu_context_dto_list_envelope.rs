...
pub struct MenuContextDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::MenuContextDto>>>,
}

impl MenuContextDtoListEnvelope {
    pub fn new() -> MenuContextDtoListEnvelope {
