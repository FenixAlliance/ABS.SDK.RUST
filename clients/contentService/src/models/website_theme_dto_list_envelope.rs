...
pub struct WebsiteThemeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebsiteThemeDto>>>,
}

impl WebsiteThemeDtoListEnvelope {
    pub fn new() -> WebsiteThemeDtoListEnvelope {
