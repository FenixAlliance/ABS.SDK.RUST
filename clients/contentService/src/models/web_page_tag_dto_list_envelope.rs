...
pub struct WebPageTagDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebPageTagDto>>>,
}

impl WebPageTagDtoListEnvelope {
    pub fn new() -> WebPageTagDtoListEnvelope {
