...
pub struct WebComponentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebComponentDto>>>,
}

impl WebComponentDtoListEnvelope {
    pub fn new() -> WebComponentDtoListEnvelope {
