...
pub struct LocalizationStringDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LocalizationStringDto>>>,
}

impl LocalizationStringDtoListEnvelope {
    pub fn new() -> LocalizationStringDtoListEnvelope {
