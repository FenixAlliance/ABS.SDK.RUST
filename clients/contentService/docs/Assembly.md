...
------------ | ------------- | ------------- | -------------
**defined_types** | Option<[**Vec<models::TypeInfo>**](TypeInfo.md)> |  | [optional][readonly]
**exported_types** | Option<[**Vec<models::Type>**](Type.md)> |  | [optional][readonly]
**code_base** | Option<**String**> |  | [optional][readonly]
**entry_point** | Option<[**models::MethodInfo**](MethodInfo.md)> |  | [optional]
...
**manifest_module** | Option<[**models::Module**](Module.md)> |  | [optional]
**modules** | Option<[**Vec<models::Module>**](Module.md)> |  | [optional][readonly]
**global_assembly_cache** | Option<**bool**> |  | [optional][readonly]
**host_context** | Option<**i64**> |  | [optional][readonly]
**security_rule_set** | Option<**String**> |  | [optional][readonly]
