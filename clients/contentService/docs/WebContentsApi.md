...
> models::Int32Envelope count_web_contents_async(tenant_id, api_version, x_api_version, web_content_dto_collection_query_parameters)
Count web contents
...
**web_content_dto_collection_query_parameters** | Option<[**WebContentDtoCollectionQueryParameters**](WebContentDtoCollectionQueryParameters.md)> |  |  |
...
> models::WebContentDtoListEnvelope get_web_contents_async(tenant_id, api_version, x_api_version, web_content_dto_collection_query_parameters)
Get web contents
...
> models::EmptyEnvelope patch_web_content_async(tenant_id, web_content_id, api_version, x_api_version, patch_operation)
Patch a web content
