...
> models::Int32Envelope count_blog_post_categories_async(tenant_id, api_version, x_api_version, blog_post_category_dto_collection_query_parameters)
...
> models::BlogPostCategoryDtoListEnvelope get_blog_post_categories_async(tenant_id, api_version, x_api_version, blog_post_category_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_blog_post_category_async(tenant_id, blog_post_category_id, api_version, x_api_version, patch_operation)
