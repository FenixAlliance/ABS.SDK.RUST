...
> models::Int32Envelope count_web_page_tags_async(tenant_id, api_version, x_api_version, web_page_tag_dto_collection_query_parameters)
Count web page tags
...
> models::WebPageTagDtoListEnvelope get_web_page_tags_async(tenant_id, api_version, x_api_version, web_page_tag_dto_collection_query_parameters)
Get web page tags
...
> models::EmptyEnvelope patch_web_page_tag_async(tenant_id, web_page_tag_id, api_version, x_api_version, patch_operation)
