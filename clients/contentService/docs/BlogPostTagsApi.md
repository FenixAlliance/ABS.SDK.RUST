...
> models::Int32Envelope count_blog_post_tags_async(tenant_id, api_version, x_api_version, blog_post_tag_dto_collection_query_parameters)
...
> models::BlogPostTagDtoListEnvelope get_blog_post_tags_async(tenant_id, api_version, x_api_version, blog_post_tag_dto_collection_query_parameters)
Get blog post tags
...
> models::EmptyEnvelope patch_blog_post_tag_async(tenant_id, blog_post_tag_id, api_version, x_api_version, patch_operation)
