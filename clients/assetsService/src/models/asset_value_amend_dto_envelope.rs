...
pub struct AssetValueAmendDtoEnvelope {
    ...
    pub result: Option<Box<models::AssetValueAmendDto>>,
}

impl AssetValueAmendDtoEnvelope {
    pub fn new() -> AssetValueAmendDtoEnvelope {
