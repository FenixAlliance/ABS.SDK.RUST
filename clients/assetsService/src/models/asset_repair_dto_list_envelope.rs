...
pub struct AssetRepairDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AssetRepairDto>>>,
}

impl AssetRepairDtoListEnvelope {
    pub fn new() -> AssetRepairDtoListEnvelope {
