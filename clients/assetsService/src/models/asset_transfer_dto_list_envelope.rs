...
pub struct AssetTransferDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AssetTransferDto>>>,
}

impl AssetTransferDtoListEnvelope {
    pub fn new() -> AssetTransferDtoListEnvelope {
