...
pub struct AssetDepreciationRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AssetDepreciationRecordDto>>>,
}

impl AssetDepreciationRecordDtoListEnvelope {
    pub fn new() -> AssetDepreciationRecordDtoListEnvelope {
