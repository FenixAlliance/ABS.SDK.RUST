...
pub struct AssetValueAmendDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AssetValueAmendDto>>>,
}

impl AssetValueAmendDtoListEnvelope {
    pub fn new() -> AssetValueAmendDtoListEnvelope {
