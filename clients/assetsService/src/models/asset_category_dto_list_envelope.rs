...
pub struct AssetCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AssetCategoryDto>>>,
}

impl AssetCategoryDtoListEnvelope {
    pub fn new() -> AssetCategoryDtoListEnvelope {
