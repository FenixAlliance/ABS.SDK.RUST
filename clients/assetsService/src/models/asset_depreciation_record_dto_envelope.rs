...
pub struct AssetDepreciationRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::AssetDepreciationRecordDto>>,
}

impl AssetDepreciationRecordDtoEnvelope {
    pub fn new() -> AssetDepreciationRecordDtoEnvelope {
