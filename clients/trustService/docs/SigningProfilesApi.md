...
> models::SigningProfileDtoListEnvelope get_signing_profiles_async(tenant_id, api_version, x_api_version)
...
> models::Int32Envelope get_signing_profiles_count_async(tenant_id, api_version, x_api_version)
...
> models::EmptyEnvelope patch_signing_profile_async(tenant_id, id, api_version, x_api_version, operation)
