...
> models::SigningLogDtoListEnvelope get_signing_logs_async(tenant_id, api_version, x_api_version)
...
> models::Int32Envelope get_signing_logs_count_async(tenant_id, api_version, x_api_version)
