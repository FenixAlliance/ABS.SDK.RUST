...
> models::SigningProfileGraphicalRepresentationDtoListEnvelope get_signing_profile_graphical_representations_async(tenant_id, api_version, x_api_version, signing_profile_graphical_representation_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**signing_profile_graphical_representation_dto_collection_query_parameters** | Option<[**SigningProfileGraphicalRepresentationDtoCollectionQueryParameters**](SigningProfileGraphicalRepresentationDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_signing_profile_graphical_representations_count_async(tenant_id, api_version, x_api_version, signing_profile_graphical_representation_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_signing_profile_graphical_representation_async(tenant_id, id, api_version, x_api_version, patch_operation)
