...
pub struct SigningProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningProfileDto>>>,
}

impl SigningProfileDtoListEnvelope {
    pub fn new() -> SigningProfileDtoListEnvelope {
