...
pub struct SigningLogDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningLogDto>>>,
}

impl SigningLogDtoListEnvelope {
    pub fn new() -> SigningLogDtoListEnvelope {
