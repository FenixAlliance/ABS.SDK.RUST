...
pub struct SigningProfileGraphicalRepresentationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningProfileGraphicalRepresentationDto>>>,
}

impl SigningProfileGraphicalRepresentationDtoListEnvelope {
    pub fn new() -> SigningProfileGraphicalRepresentationDtoListEnvelope {
