...
pub struct TrustArtifactReferenceDtoEnvelope {
    ...
    pub result: Option<Box<models::TrustArtifactReferenceDto>>,
}

impl TrustArtifactReferenceDtoEnvelope {
    pub fn new() -> TrustArtifactReferenceDtoEnvelope {
