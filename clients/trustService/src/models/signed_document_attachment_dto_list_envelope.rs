...
pub struct SignedDocumentAttachmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SignedDocumentAttachmentDto>>>,
}

impl SignedDocumentAttachmentDtoListEnvelope {
    pub fn new() -> SignedDocumentAttachmentDtoListEnvelope {
