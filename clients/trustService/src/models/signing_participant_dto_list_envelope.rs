...
pub struct SigningParticipantDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningParticipantDto>>>,
}

impl SigningParticipantDtoListEnvelope {
    pub fn new() -> SigningParticipantDtoListEnvelope {
