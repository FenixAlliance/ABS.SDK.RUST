...
pub struct TrustSigningProviderDescriptorDtoCollectionQueryParameters {
...
impl TrustSigningProviderDescriptorDtoCollectionQueryParameters {
    pub fn new() -> TrustSigningProviderDescriptorDtoCollectionQueryParameters {
