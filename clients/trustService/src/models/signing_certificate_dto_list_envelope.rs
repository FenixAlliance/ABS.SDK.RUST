...
pub struct SigningCertificateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningCertificateDto>>>,
}

impl SigningCertificateDtoListEnvelope {
    pub fn new() -> SigningCertificateDtoListEnvelope {
