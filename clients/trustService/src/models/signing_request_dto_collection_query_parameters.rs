...
pub struct SigningRequestDtoCollectionQueryParameters {
...
impl SigningRequestDtoCollectionQueryParameters {
    pub fn new() -> SigningRequestDtoCollectionQueryParameters {
