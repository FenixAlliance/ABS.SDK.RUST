...
pub struct TrustSigningReadinessDtoEnvelope {
    ...
    pub result: Option<Box<models::TrustSigningReadinessDto>>,
}

impl TrustSigningReadinessDtoEnvelope {
    pub fn new() -> TrustSigningReadinessDtoEnvelope {
