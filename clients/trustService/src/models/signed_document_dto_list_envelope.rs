...
pub struct SignedDocumentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SignedDocumentDto>>>,
}

impl SignedDocumentDtoListEnvelope {
    pub fn new() -> SignedDocumentDtoListEnvelope {
