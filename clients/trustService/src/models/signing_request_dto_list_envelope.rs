...
pub struct SigningRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SigningRequestDto>>>,
}

impl SigningRequestDtoListEnvelope {
    pub fn new() -> SigningRequestDtoListEnvelope {
