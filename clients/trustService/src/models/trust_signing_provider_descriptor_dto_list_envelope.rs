...
pub struct TrustSigningProviderDescriptorDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TrustSigningProviderDescriptorDto>>>,
}

impl TrustSigningProviderDescriptorDtoListEnvelope {
    pub fn new() -> TrustSigningProviderDescriptorDtoListEnvelope {
