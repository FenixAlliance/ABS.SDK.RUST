...
> models::Int32Envelope get_email_templates_count_async(tenant_id, api_version, x_api_version, email_template_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**email_template_dto_collection_query_parameters** | Option<[**EmailTemplateDtoCollectionQueryParameters**](EmailTemplateDtoCollectionQueryParameters.md)> |  |  |
...
> models::EmailTemplateDtoListEnvelope get_email_templates_o_data_async(tenant_id, api_version, x_api_version, email_template_dto_collection_query_parameters)
Get email templates
...
> models::EmptyEnvelope patch_email_template_async(tenant_id, email_template_id, api_version, x_api_version, patch_operation)
