...
> get_newsletter_o_data_async(tenant_id, api_version, x_api_version, newsletter_dto_collection_query_parameters)
Get newsletters
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**newsletter_dto_collection_query_parameters** | Option<[**NewsletterDtoCollectionQueryParameters**](NewsletterDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_newsletters_count_async(tenant_id, api_version, x_api_version, newsletter_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_newsletter_async(tenant_id, newsletter_id, api_version, x_api_version, patch_operation)
Patch a newsletter
