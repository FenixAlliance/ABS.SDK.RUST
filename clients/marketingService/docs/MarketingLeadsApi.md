...
> models::Int32Envelope get_marketing_leads_count_async(tenant_id, api_version, x_api_version, marketing_lead_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**marketing_lead_dto_collection_query_parameters** | Option<[**MarketingLeadDtoCollectionQueryParameters**](MarketingLeadDtoCollectionQueryParameters.md)> |  |  |
...
> models::MarketingLeadDtoListEnvelope get_marketing_leads_o_data_async(tenant_id, api_version, x_api_version, marketing_lead_dto_collection_query_parameters)
Get marketing leads
...
> models::EmptyEnvelope patch_marketing_lead_async(tenant_id, marketing_lead_id, api_version, x_api_version, patch_operation)
