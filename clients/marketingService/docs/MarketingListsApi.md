...
> models::MarketingListDtoListEnvelope get_marketing_list_o_data_async(tenant_id, api_version, x_api_version, marketing_list_dto_collection_query_parameters)
Get marketing lists
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**marketing_list_dto_collection_query_parameters** | Option<[**MarketingListDtoCollectionQueryParameters**](MarketingListDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_marketing_lists_count_async(tenant_id, api_version, x_api_version, marketing_list_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_marketing_list_async(tenant_id, marketinglist_id, api_version, x_api_version, patch_operation)
