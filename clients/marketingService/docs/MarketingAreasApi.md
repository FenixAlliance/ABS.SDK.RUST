...
> models::MarketingAreaDtoListEnvelope get_marketing_areas_async(tenant_id, api_version, x_api_version, marketing_area_dto_collection_query_parameters)
Get marketing areas
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**marketing_area_dto_collection_query_parameters** | Option<[**MarketingAreaDtoCollectionQueryParameters**](MarketingAreaDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_marketing_areas_count_async(tenant_id, api_version, x_api_version, marketing_area_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_marketing_area_async(tenant_id, marketing_area_id, api_version, x_api_version, patch_operation)
