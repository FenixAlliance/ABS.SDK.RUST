...
pub struct EmailSignatureDtoCollectionQueryParameters {
...
impl EmailSignatureDtoCollectionQueryParameters {
    pub fn new() -> EmailSignatureDtoCollectionQueryParameters {
