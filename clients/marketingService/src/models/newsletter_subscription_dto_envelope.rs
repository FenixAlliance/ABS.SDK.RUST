...
pub struct NewsletterSubscriptionDtoEnvelope {
    ...
    pub result: Option<Box<models::NewsletterSubscriptionDto>>,
}

impl NewsletterSubscriptionDtoEnvelope {
    pub fn new() -> NewsletterSubscriptionDtoEnvelope {
