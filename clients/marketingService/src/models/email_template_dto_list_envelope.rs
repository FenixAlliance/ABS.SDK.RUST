...
pub struct EmailTemplateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmailTemplateDto>>>,
}

impl EmailTemplateDtoListEnvelope {
    pub fn new() -> EmailTemplateDtoListEnvelope {
