...
pub struct SocialMediaPostDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialMediaPostDto>>>,
}

impl SocialMediaPostDtoListEnvelope {
    pub fn new() -> SocialMediaPostDtoListEnvelope {
