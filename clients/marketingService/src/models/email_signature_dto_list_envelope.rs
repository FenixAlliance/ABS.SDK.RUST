...
pub struct EmailSignatureDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmailSignatureDto>>>,
}

impl EmailSignatureDtoListEnvelope {
    pub fn new() -> EmailSignatureDtoListEnvelope {
