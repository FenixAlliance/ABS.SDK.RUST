...
pub struct SocialMediaPostDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialMediaPostDto>>,
}

impl SocialMediaPostDtoEnvelope {
    pub fn new() -> SocialMediaPostDtoEnvelope {
