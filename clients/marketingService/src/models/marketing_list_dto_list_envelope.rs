...
pub struct MarketingListDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::MarketingListDto>>>,
}

impl MarketingListDtoListEnvelope {
    pub fn new() -> MarketingListDtoListEnvelope {
