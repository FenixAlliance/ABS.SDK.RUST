...
pub struct NewsletterSubscriptionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::NewsletterSubscriptionDto>>>,
}

impl NewsletterSubscriptionDtoListEnvelope {
    pub fn new() -> NewsletterSubscriptionDtoListEnvelope {
