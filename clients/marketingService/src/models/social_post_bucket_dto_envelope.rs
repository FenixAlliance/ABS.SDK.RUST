...
pub struct SocialPostBucketDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialPostBucketDto>>,
}

impl SocialPostBucketDtoEnvelope {
    pub fn new() -> SocialPostBucketDtoEnvelope {
