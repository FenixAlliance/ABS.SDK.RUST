...
pub struct EmailGroupDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmailGroupDto>>>,
}

impl EmailGroupDtoListEnvelope {
    pub fn new() -> EmailGroupDtoListEnvelope {
