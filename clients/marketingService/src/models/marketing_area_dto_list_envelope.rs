...
pub struct MarketingAreaDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::MarketingAreaDto>>>,
}

impl MarketingAreaDtoListEnvelope {
    pub fn new() -> MarketingAreaDtoListEnvelope {
