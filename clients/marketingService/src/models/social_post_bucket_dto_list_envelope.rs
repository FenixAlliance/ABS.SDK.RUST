...
pub struct SocialPostBucketDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialPostBucketDto>>>,
}

impl SocialPostBucketDtoListEnvelope {
    pub fn new() -> SocialPostBucketDtoListEnvelope {
