...
pub struct MarketingLeadDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::MarketingLeadDto>>>,
}

impl MarketingLeadDtoListEnvelope {
    pub fn new() -> MarketingLeadDtoListEnvelope {
