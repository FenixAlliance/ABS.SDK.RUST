...
pub struct MarketingCampaignDtoEnvelope {
    ...
    pub result: Option<Box<models::MarketingCampaignDto>>,
}

impl MarketingCampaignDtoEnvelope {
    pub fn new() -> MarketingCampaignDtoEnvelope {
