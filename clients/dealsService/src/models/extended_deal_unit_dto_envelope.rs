...
pub struct ExtendedDealUnitDtoEnvelope {
    ...
    pub result: Option<Box<models::ExtendedDealUnitDto>>,
}

impl ExtendedDealUnitDtoEnvelope {
    pub fn new() -> ExtendedDealUnitDtoEnvelope {
