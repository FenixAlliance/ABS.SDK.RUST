...
pub struct ExtendedDealUnitDtoCollectionQueryParameters {
...
impl ExtendedDealUnitDtoCollectionQueryParameters {
    pub fn new() -> ExtendedDealUnitDtoCollectionQueryParameters {
