...
pub struct DealUnitLineDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::DealUnitLineDto>>>,
}

impl DealUnitLineDtoListEnvelope {
    pub fn new() -> DealUnitLineDtoListEnvelope {
