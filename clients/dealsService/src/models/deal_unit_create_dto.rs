...
pub struct DealUnitCreateDto {
    ...
    #[serde(rename = "dealUnitLines", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub deal_unit_lines: Option<Option<Vec<models::DealUnitLineCreateDto>>>,
}

impl DealUnitCreateDto {
    pub fn new() -> DealUnitCreateDto {
        DealUnitCreateDto {
            id: None,
            timestamp: None,
            closed: None,
