...
pub struct DealUnitFlowStageDtoEnvelope {
    ...
    pub result: Option<Box<models::DealUnitFlowStageDto>>,
}

impl DealUnitFlowStageDtoEnvelope {
    pub fn new() -> DealUnitFlowStageDtoEnvelope {
