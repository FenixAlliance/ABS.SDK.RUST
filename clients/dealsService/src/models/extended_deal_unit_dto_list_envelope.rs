...
pub struct ExtendedDealUnitDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedDealUnitDto>>>,
}

impl ExtendedDealUnitDtoListEnvelope {
    pub fn new() -> ExtendedDealUnitDtoListEnvelope {
