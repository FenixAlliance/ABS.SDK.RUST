...
pub struct DealUnitFlowStageDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::DealUnitFlowStageDto>>>,
}

impl DealUnitFlowStageDtoListEnvelope {
    pub fn new() -> DealUnitFlowStageDtoListEnvelope {
