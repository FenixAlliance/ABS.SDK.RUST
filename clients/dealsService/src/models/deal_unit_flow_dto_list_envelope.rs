...
pub struct DealUnitFlowDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::DealUnitFlowDto>>>,
}

impl DealUnitFlowDtoListEnvelope {
    pub fn new() -> DealUnitFlowDtoListEnvelope {
