...
pub struct ItemCartRecordDto {
    ...
    #[serde(rename = "itemID", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub item_id: Option<Option<String>>,
    #[serde(rename = "shippingAddressID", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub shipping_address_id: Option<Option<String>>,
}

impl ItemCartRecordDto {
    pub fn new() -> ItemCartRecordDto {
        ItemCartRecordDto {
            id: None,
            timestamp: None,
            closed: None,
