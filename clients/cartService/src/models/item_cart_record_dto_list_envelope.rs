...
pub struct ItemCartRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemCartRecordDto>>>,
}

impl ItemCartRecordDtoListEnvelope {
    pub fn new() -> ItemCartRecordDtoListEnvelope {
