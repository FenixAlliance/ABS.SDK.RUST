...
pub struct ItemToCompareCartRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemToCompareCartRecordDto>>,
}

impl ItemToCompareCartRecordDtoEnvelope {
    pub fn new() -> ItemToCompareCartRecordDtoEnvelope {
