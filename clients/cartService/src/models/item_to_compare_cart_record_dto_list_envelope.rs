...
pub struct ItemToCompareCartRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemToCompareCartRecordDto>>>,
}

impl ItemToCompareCartRecordDtoListEnvelope {
    pub fn new() -> ItemToCompareCartRecordDtoListEnvelope {
