...
pub struct LoanDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LoanDto>>>,
}

impl LoanDtoIReadOnlyListEnvelope {
    pub fn new() -> LoanDtoIReadOnlyListEnvelope {
