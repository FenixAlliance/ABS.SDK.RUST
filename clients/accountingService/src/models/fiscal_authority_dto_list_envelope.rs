...
pub struct FiscalAuthorityDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalAuthorityDto>>>,
}

impl FiscalAuthorityDtoListEnvelope {
    pub fn new() -> FiscalAuthorityDtoListEnvelope {
