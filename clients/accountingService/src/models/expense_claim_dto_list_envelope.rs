...
pub struct ExpenseClaimDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExpenseClaimDto>>>,
}

impl ExpenseClaimDtoListEnvelope {
    pub fn new() -> ExpenseClaimDtoListEnvelope {
