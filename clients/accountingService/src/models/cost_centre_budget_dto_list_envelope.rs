...
pub struct CostCentreBudgetDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CostCentreBudgetDto>>>,
}

impl CostCentreBudgetDtoListEnvelope {
    pub fn new() -> CostCentreBudgetDtoListEnvelope {
