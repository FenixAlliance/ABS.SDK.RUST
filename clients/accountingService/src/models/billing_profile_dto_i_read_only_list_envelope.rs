...
pub struct BillingProfileDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BillingProfileDto>>>,
}

impl BillingProfileDtoIReadOnlyListEnvelope {
    pub fn new() -> BillingProfileDtoIReadOnlyListEnvelope {
