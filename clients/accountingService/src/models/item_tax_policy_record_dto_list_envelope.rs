...
pub struct ItemTaxPolicyRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemTaxPolicyRecordDto>>>,
}

impl ItemTaxPolicyRecordDtoListEnvelope {
    pub fn new() -> ItemTaxPolicyRecordDtoListEnvelope {
