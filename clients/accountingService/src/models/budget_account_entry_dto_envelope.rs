...
pub struct BudgetAccountEntryDtoEnvelope {
    ...
    pub result: Option<Box<models::BudgetAccountEntryDto>>,
}

impl BudgetAccountEntryDtoEnvelope {
    pub fn new() -> BudgetAccountEntryDtoEnvelope {
