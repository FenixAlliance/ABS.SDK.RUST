...
pub struct CommissionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CommissionDto>>>,
}

impl CommissionDtoListEnvelope {
    pub fn new() -> CommissionDtoListEnvelope {
