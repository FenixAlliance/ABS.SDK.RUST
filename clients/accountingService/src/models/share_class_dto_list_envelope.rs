...
pub struct ShareClassDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShareClassDto>>>,
}

impl ShareClassDtoListEnvelope {
    pub fn new() -> ShareClassDtoListEnvelope {
