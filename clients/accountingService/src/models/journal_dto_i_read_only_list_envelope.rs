...
pub struct JournalDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JournalDto>>>,
}

impl JournalDtoIReadOnlyListEnvelope {
    pub fn new() -> JournalDtoIReadOnlyListEnvelope {
