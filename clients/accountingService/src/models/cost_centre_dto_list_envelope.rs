...
pub struct CostCentreDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CostCentreDto>>>,
}

impl CostCentreDtoListEnvelope {
    pub fn new() -> CostCentreDtoListEnvelope {
