...
pub struct InvoiceEnumerationRangeDtoEnvelope {
    ...
    pub result: Option<Box<models::InvoiceEnumerationRangeDto>>,
}

impl InvoiceEnumerationRangeDtoEnvelope {
    pub fn new() -> InvoiceEnumerationRangeDtoEnvelope {
