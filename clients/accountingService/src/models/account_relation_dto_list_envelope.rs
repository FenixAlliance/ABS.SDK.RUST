...
pub struct AccountRelationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AccountRelationDto>>>,
}

impl AccountRelationDtoListEnvelope {
    pub fn new() -> AccountRelationDtoListEnvelope {
