...
pub struct BudgetAccountEntryDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BudgetAccountEntryDto>>>,
}

impl BudgetAccountEntryDtoIReadOnlyListEnvelope {
    pub fn new() -> BudgetAccountEntryDtoIReadOnlyListEnvelope {
