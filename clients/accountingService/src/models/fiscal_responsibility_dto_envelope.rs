...
pub struct FiscalResponsibilityDtoEnvelope {
    ...
    pub result: Option<Box<models::FiscalResponsibilityDto>>,
}

impl FiscalResponsibilityDtoEnvelope {
    pub fn new() -> FiscalResponsibilityDtoEnvelope {
