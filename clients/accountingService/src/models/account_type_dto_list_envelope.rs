...
pub struct AccountTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AccountTypeDto>>>,
}

impl AccountTypeDtoListEnvelope {
    pub fn new() -> AccountTypeDtoListEnvelope {
