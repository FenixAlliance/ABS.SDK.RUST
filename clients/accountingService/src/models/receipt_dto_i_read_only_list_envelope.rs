...
pub struct ReceiptDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ReceiptDto>>>,
}

impl ReceiptDtoIReadOnlyListEnvelope {
    pub fn new() -> ReceiptDtoIReadOnlyListEnvelope {
