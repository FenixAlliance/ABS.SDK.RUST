...
pub struct AccountGroupDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AccountGroupDto>>>,
}

impl AccountGroupDtoListEnvelope {
    pub fn new() -> AccountGroupDtoListEnvelope {
