...
pub struct FiscalIdentificationTypeDtoEnvelope {
    ...
    pub result: Option<Box<models::FiscalIdentificationTypeDto>>,
}

impl FiscalIdentificationTypeDtoEnvelope {
    pub fn new() -> FiscalIdentificationTypeDtoEnvelope {
