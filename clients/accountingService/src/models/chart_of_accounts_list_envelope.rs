...
pub struct ChartOfAccountsListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ChartOfAccounts>>>,
}

impl ChartOfAccountsListEnvelope {
    pub fn new() -> ChartOfAccountsListEnvelope {
