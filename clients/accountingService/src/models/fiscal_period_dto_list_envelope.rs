...
pub struct FiscalPeriodDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalPeriodDto>>>,
}

impl FiscalPeriodDtoListEnvelope {
    pub fn new() -> FiscalPeriodDtoListEnvelope {
