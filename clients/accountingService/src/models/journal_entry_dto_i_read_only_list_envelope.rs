...
pub struct JournalEntryDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JournalEntryDto>>>,
}

impl JournalEntryDtoIReadOnlyListEnvelope {
    pub fn new() -> JournalEntryDtoIReadOnlyListEnvelope {
