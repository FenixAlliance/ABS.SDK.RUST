...
pub struct AccountingPeriodDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AccountingPeriodDto>>>,
}

impl AccountingPeriodDtoListEnvelope {
    pub fn new() -> AccountingPeriodDtoListEnvelope {
