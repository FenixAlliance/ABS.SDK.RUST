...
pub struct AccountingEntryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AccountingEntryDto>>>,
}

impl AccountingEntryDtoListEnvelope {
    pub fn new() -> AccountingEntryDtoListEnvelope {
