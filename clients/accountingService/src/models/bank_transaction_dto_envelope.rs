...
pub struct BankTransactionDtoEnvelope {
    ...
    pub result: Option<Box<models::BankTransactionDto>>,
}

impl BankTransactionDtoEnvelope {
    pub fn new() -> BankTransactionDtoEnvelope {
