...
pub struct FiscalResponsibilityRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::FiscalResponsibilityRecordDto>>,
}

impl FiscalResponsibilityRecordDtoEnvelope {
    pub fn new() -> FiscalResponsibilityRecordDtoEnvelope {
