...
pub struct JournalTypeDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JournalTypeDto>>>,
}

impl JournalTypeDtoIReadOnlyListEnvelope {
    pub fn new() -> JournalTypeDtoIReadOnlyListEnvelope {
