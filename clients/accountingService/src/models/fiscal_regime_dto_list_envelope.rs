...
pub struct FiscalRegimeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalRegimeDto>>>,
}

impl FiscalRegimeDtoListEnvelope {
    pub fn new() -> FiscalRegimeDtoListEnvelope {
