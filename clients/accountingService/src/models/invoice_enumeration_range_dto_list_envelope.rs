...
pub struct InvoiceEnumerationRangeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InvoiceEnumerationRangeDto>>>,
}

impl InvoiceEnumerationRangeDtoListEnvelope {
    pub fn new() -> InvoiceEnumerationRangeDtoListEnvelope {
