...
pub struct FiscalYearDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalYearDto>>>,
}

impl FiscalYearDtoIReadOnlyListEnvelope {
    pub fn new() -> FiscalYearDtoIReadOnlyListEnvelope {
