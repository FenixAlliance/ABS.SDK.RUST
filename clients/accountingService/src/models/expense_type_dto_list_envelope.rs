...
pub struct ExpenseTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExpenseTypeDto>>>,
}

impl ExpenseTypeDtoListEnvelope {
    pub fn new() -> ExpenseTypeDtoListEnvelope {
