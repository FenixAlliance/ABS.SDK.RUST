...
pub struct FiscalIdentificationTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalIdentificationTypeDto>>>,
}

impl FiscalIdentificationTypeDtoListEnvelope {
    pub fn new() -> FiscalIdentificationTypeDtoListEnvelope {
