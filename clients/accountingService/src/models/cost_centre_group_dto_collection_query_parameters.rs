...
pub struct CostCentreGroupDtoCollectionQueryParameters {
...
impl CostCentreGroupDtoCollectionQueryParameters {
    pub fn new() -> CostCentreGroupDtoCollectionQueryParameters {
