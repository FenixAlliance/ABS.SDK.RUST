...
pub struct TaxPolicyCreateDto {
    ...
    #[serde(rename = "taxSchemeCode", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tax_scheme_code: Option<Option<String>>,
    #[serde(rename = "taxCategoryCode", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub tax_category_code: Option<Option<String>>,
...
impl TaxPolicyCreateDto {
    pub fn new() -> TaxPolicyCreateDto {
        TaxPolicyCreateDto {
            id: None,
            timestamp: None,
            code: None,
