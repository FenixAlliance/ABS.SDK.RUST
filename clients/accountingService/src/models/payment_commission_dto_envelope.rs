...
pub struct PaymentCommissionDtoEnvelope {
    ...
    pub result: Option<Box<models::PaymentCommissionDto>>,
}

impl PaymentCommissionDtoEnvelope {
    pub fn new() -> PaymentCommissionDtoEnvelope {
