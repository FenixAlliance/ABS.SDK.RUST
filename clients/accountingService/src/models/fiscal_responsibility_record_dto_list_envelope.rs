...
pub struct FiscalResponsibilityRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalResponsibilityRecordDto>>>,
}

impl FiscalResponsibilityRecordDtoListEnvelope {
    pub fn new() -> FiscalResponsibilityRecordDtoListEnvelope {
