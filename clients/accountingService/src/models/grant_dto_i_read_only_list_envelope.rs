...
pub struct GrantDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::GrantDto>>>,
}

impl GrantDtoIReadOnlyListEnvelope {
    pub fn new() -> GrantDtoIReadOnlyListEnvelope {
