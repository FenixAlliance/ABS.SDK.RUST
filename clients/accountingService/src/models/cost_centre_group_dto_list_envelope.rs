...
pub struct CostCentreGroupDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CostCentreGroupDto>>>,
}

impl CostCentreGroupDtoListEnvelope {
    pub fn new() -> CostCentreGroupDtoListEnvelope {
