...
pub struct PostingExecutionDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PostingExecutionDto>>>,
}

impl PostingExecutionDtoIReadOnlyListEnvelope {
    pub fn new() -> PostingExecutionDtoIReadOnlyListEnvelope {
