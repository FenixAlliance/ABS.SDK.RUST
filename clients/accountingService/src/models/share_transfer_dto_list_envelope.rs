...
pub struct ShareTransferDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShareTransferDto>>>,
}

impl ShareTransferDtoListEnvelope {
    pub fn new() -> ShareTransferDtoListEnvelope {
