...
pub struct BankProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BankProfileDto>>>,
}

impl BankProfileDtoListEnvelope {
    pub fn new() -> BankProfileDtoListEnvelope {
