...
pub struct ItemTaxPolicyRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemTaxPolicyRecordDto>>,
}

impl ItemTaxPolicyRecordDtoEnvelope {
    pub fn new() -> ItemTaxPolicyRecordDtoEnvelope {
