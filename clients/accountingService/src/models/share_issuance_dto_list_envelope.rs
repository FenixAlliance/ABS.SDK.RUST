...
pub struct ShareIssuanceDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShareIssuanceDto>>>,
}

impl ShareIssuanceDtoListEnvelope {
    pub fn new() -> ShareIssuanceDtoListEnvelope {
