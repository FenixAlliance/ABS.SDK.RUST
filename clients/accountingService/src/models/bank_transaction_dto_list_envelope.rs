...
pub struct BankTransactionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BankTransactionDto>>>,
}

impl BankTransactionDtoListEnvelope {
    pub fn new() -> BankTransactionDtoListEnvelope {
