...
pub struct CostCentreBudgetDtoEnvelope {
    ...
    pub result: Option<Box<models::CostCentreBudgetDto>>,
}

impl CostCentreBudgetDtoEnvelope {
    pub fn new() -> CostCentreBudgetDtoEnvelope {
