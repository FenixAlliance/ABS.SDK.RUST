...
pub struct AccountingPeriodDtoEnvelope {
    ...
    pub result: Option<Box<models::AccountingPeriodDto>>,
}

impl AccountingPeriodDtoEnvelope {
    pub fn new() -> AccountingPeriodDtoEnvelope {
