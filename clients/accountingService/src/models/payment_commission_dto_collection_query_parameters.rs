...
pub struct PaymentCommissionDtoCollectionQueryParameters {
...
impl PaymentCommissionDtoCollectionQueryParameters {
    pub fn new() -> PaymentCommissionDtoCollectionQueryParameters {
