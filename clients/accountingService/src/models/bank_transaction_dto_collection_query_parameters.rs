...
pub struct BankTransactionDtoCollectionQueryParameters {
...
impl BankTransactionDtoCollectionQueryParameters {
    pub fn new() -> BankTransactionDtoCollectionQueryParameters {
