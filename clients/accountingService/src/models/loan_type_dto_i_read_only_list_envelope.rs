...
pub struct LoanTypeDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LoanTypeDto>>>,
}

impl LoanTypeDtoIReadOnlyListEnvelope {
    pub fn new() -> LoanTypeDtoIReadOnlyListEnvelope {
