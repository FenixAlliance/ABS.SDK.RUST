...
pub struct LoanApplicationDtoCollectionQueryParameters {
...
impl LoanApplicationDtoCollectionQueryParameters {
    pub fn new() -> LoanApplicationDtoCollectionQueryParameters {
