...
pub struct LoanApplicationDtoEnvelope {
    ...
    pub result: Option<Box<models::LoanApplicationDto>>,
}

impl LoanApplicationDtoEnvelope {
    pub fn new() -> LoanApplicationDtoEnvelope {
