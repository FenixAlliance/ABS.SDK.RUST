...
pub struct BudgetDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BudgetDto>>>,
}

impl BudgetDtoIReadOnlyListEnvelope {
    pub fn new() -> BudgetDtoIReadOnlyListEnvelope {
