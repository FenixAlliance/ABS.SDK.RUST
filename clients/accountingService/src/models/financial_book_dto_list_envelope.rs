...
pub struct FinancialBookDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FinancialBookDto>>>,
}

impl FinancialBookDtoListEnvelope {
    pub fn new() -> FinancialBookDtoListEnvelope {
