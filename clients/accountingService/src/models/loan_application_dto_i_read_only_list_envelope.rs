...
pub struct LoanApplicationDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LoanApplicationDto>>>,
}

impl LoanApplicationDtoIReadOnlyListEnvelope {
    pub fn new() -> LoanApplicationDtoIReadOnlyListEnvelope {
