...
pub struct TransactionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TransactionDto>>>,
}

impl TransactionDtoListEnvelope {
    pub fn new() -> TransactionDtoListEnvelope {
