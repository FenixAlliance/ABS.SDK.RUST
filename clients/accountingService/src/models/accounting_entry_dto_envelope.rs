...
pub struct AccountingEntryDtoEnvelope {
    ...
    pub result: Option<Box<models::AccountingEntryDto>>,
}

impl AccountingEntryDtoEnvelope {
    pub fn new() -> AccountingEntryDtoEnvelope {
