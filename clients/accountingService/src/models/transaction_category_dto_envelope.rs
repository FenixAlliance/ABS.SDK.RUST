...
pub struct TransactionCategoryDtoEnvelope {
    ...
    pub result: Option<Box<models::TransactionCategoryDto>>,
}

impl TransactionCategoryDtoEnvelope {
    pub fn new() -> TransactionCategoryDtoEnvelope {
