...
pub struct CostCentreGroupDtoEnvelope {
    ...
    pub result: Option<Box<models::CostCentreGroupDto>>,
}

impl CostCentreGroupDtoEnvelope {
    pub fn new() -> CostCentreGroupDtoEnvelope {
