...
pub struct LedgerTypeDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LedgerTypeDto>>>,
}

impl LedgerTypeDtoIReadOnlyListEnvelope {
    pub fn new() -> LedgerTypeDtoIReadOnlyListEnvelope {
