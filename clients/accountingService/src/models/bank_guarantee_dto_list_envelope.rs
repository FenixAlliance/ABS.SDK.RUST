...
pub struct BankGuaranteeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BankGuaranteeDto>>>,
}

impl BankGuaranteeDtoListEnvelope {
    pub fn new() -> BankGuaranteeDtoListEnvelope {
