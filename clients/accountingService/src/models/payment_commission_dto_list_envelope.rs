...
pub struct PaymentCommissionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentCommissionDto>>>,
}

impl PaymentCommissionDtoListEnvelope {
    pub fn new() -> PaymentCommissionDtoListEnvelope {
