...
pub struct FiscalAuthorityDtoEnvelope {
    ...
    pub result: Option<Box<models::FiscalAuthorityDto>>,
}

impl FiscalAuthorityDtoEnvelope {
    pub fn new() -> FiscalAuthorityDtoEnvelope {
