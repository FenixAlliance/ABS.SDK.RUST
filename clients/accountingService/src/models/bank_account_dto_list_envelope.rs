...
pub struct BankAccountDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BankAccountDto>>>,
}

impl BankAccountDtoListEnvelope {
    pub fn new() -> BankAccountDtoListEnvelope {
