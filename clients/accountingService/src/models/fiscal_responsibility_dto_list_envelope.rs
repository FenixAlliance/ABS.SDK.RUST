...
pub struct FiscalResponsibilityDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FiscalResponsibilityDto>>>,
}

impl FiscalResponsibilityDtoListEnvelope {
    pub fn new() -> FiscalResponsibilityDtoListEnvelope {
