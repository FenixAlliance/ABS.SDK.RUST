...
pub struct AppliedTaxPolicyRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::AppliedTaxPolicyRecordDto>>,
}

impl AppliedTaxPolicyRecordDtoEnvelope {
    pub fn new() -> AppliedTaxPolicyRecordDtoEnvelope {
