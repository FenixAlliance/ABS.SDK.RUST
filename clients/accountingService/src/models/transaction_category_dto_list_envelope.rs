...
pub struct TransactionCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TransactionCategoryDto>>>,
}

impl TransactionCategoryDtoListEnvelope {
    pub fn new() -> TransactionCategoryDtoListEnvelope {
