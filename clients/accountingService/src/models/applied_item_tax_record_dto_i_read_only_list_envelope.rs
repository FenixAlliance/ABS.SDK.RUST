...
pub struct AppliedItemTaxRecordDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AppliedItemTaxRecordDto>>>,
}

impl AppliedItemTaxRecordDtoIReadOnlyListEnvelope {
    pub fn new() -> AppliedItemTaxRecordDtoIReadOnlyListEnvelope {
