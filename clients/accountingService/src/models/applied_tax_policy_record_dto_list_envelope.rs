...
pub struct AppliedTaxPolicyRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AppliedTaxPolicyRecordDto>>>,
}

impl AppliedTaxPolicyRecordDtoListEnvelope {
    pub fn new() -> AppliedTaxPolicyRecordDtoListEnvelope {
