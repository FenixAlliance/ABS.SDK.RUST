...
pub struct FinancialBookDtoCollectionQueryParameters {
...
impl FinancialBookDtoCollectionQueryParameters {
    pub fn new() -> FinancialBookDtoCollectionQueryParameters {
