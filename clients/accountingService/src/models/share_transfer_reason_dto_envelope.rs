...
pub struct ShareTransferReasonDtoEnvelope {
    ...
    pub result: Option<Box<models::ShareTransferReasonDto>>,
}

impl ShareTransferReasonDtoEnvelope {
    pub fn new() -> ShareTransferReasonDtoEnvelope {
