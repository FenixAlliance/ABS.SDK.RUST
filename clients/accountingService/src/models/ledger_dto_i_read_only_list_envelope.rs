...
pub struct LedgerDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LedgerDto>>>,
}

impl LedgerDtoIReadOnlyListEnvelope {
    pub fn new() -> LedgerDtoIReadOnlyListEnvelope {
