...
pub struct ShareTransferReasonDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShareTransferReasonDto>>>,
}

impl ShareTransferReasonDtoListEnvelope {
    pub fn new() -> ShareTransferReasonDtoListEnvelope {
