...
/// struct for typed errors of method [`get_credits_sum_async`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetCreditsSumAsyncError {
    Status401(models::ErrorEnvelope),
    Status403(models::ErrorEnvelope),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_debits_sum_async`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetDebitsSumAsyncError {
    Status401(models::ErrorEnvelope),
    Status403(models::ErrorEnvelope),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_expenses_sum_async`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetExpensesSumAsyncError {
    Status401(models::ErrorEnvelope),
    Status403(models::ErrorEnvelope),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_incomes_sum_async`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetIncomesSumAsyncError {
    Status401(models::ErrorEnvelope),
    Status403(models::ErrorEnvelope),
    UnknownValue(serde_json::Value),
}
...
pub async fn get_credits_sum_async(configuration: &configuration::Configuration, tenant_id: &str, api_version: Option<&str>, x_api_version: Option<&str>) -> Result<models::DecimalEnvelope, Error<GetCreditsSumAsyncError>> {
    ...
    let local_var_uri_str = format!("{}/api/v2/AccountingService/Summary/Credits/Sum", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCreditsSumAsyncError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn get_debits_sum_async(configuration: &configuration::Configuration, tenant_id: &str, api_version: Option<&str>, x_api_version: Option<&str>) -> Result<models::DecimalEnvelope, Error<GetDebitsSumAsyncError>> {
    ...
    let local_var_uri_str = format!("{}/api/v2/AccountingService/Summary/Debits/Sum", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDebitsSumAsyncError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_expenses_sum_async(configuration: &configuration::Configuration, tenant_id: &str, api_version: Option<&str>, x_api_version: Option<&str>) -> Result<models::MoneyEnvelope, Error<GetExpensesSumAsyncError>> {
    ...
    let local_var_uri_str = format!("{}/api/v2/AccountingService/Summary/Expenses/Sum", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetExpensesSumAsyncError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn get_incomes_sum_async(configuration: &configuration::Configuration, tenant_id: &str, api_version: Option<&str>, x_api_version: Option<&str>) -> Result<models::MoneyEnvelope, Error<GetIncomesSumAsyncError>> {
    ...
    let local_var_uri_str = format!("{}/api/v2/AccountingService/Summary/Incomes/Sum", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetIncomesSumAsyncError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
