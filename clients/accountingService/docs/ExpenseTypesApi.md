...
> models::ExpenseTypeDtoListEnvelope get_expense_types(tenant_id, api_version, x_api_version, expense_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**expense_type_dto_collection_query_parameters** | Option<[**ExpenseTypeDtoCollectionQueryParameters**](ExpenseTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_expense_types_count(tenant_id, api_version, x_api_version, expense_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_expense_type(tenant_id, expense_type_id, api_version, x_api_version, patch_operation)
