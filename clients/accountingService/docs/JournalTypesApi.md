...
> models::JournalTypeDtoIReadOnlyListEnvelope get_journal_types_async(tenant_id, api_version, x_api_version, journal_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**journal_type_dto_collection_query_parameters** | Option<[**JournalTypeDtoCollectionQueryParameters**](JournalTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_journal_types_count_async(tenant_id, api_version, x_api_version, journal_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_journal_type_async(tenant_id, journal_type_id, api_version, x_api_version, patch_operation)
