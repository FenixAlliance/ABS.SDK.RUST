...
> models::FiscalYearDtoIReadOnlyListEnvelope get_fiscal_years_async(tenant_id, api_version, x_api_version, fiscal_year_dto_collection_query_parameters)
...
> models::Int32Envelope get_fiscal_years_count_async(tenant_id, api_version, x_api_version, fiscal_year_dto_collection_query_parameters)
Count fiscal years
...
> models::EmptyEnvelope patch_fiscal_year_async(tenant_id, fiscal_year_id, api_version, x_api_version, patch_operation)
Patch a fiscal year
