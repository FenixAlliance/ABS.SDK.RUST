...
> models::TaxRateDtoListEnvelope get_tax_rates(tenant_id, api_version, x_api_version, tax_rate_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**tax_rate_dto_collection_query_parameters** | Option<[**TaxRateDtoCollectionQueryParameters**](TaxRateDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_tax_rates_count(tenant_id, api_version, x_api_version, tax_rate_dto_collection_query_parameters)
Get tax rates count
...
> models::EmptyEnvelope patch_tax_rate(tenant_id, id, api_version, x_api_version, patch_operation)
Patch a tax rate
