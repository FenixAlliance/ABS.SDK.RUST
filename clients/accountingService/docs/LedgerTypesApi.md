...
> models::LedgerTypeDtoIReadOnlyListEnvelope get_ledger_types_async(tenant_id, api_version, x_api_version, ledger_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**ledger_type_dto_collection_query_parameters** | Option<[**LedgerTypeDtoCollectionQueryParameters**](LedgerTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_ledger_types_count_async(tenant_id, api_version, x_api_version, ledger_type_dto_collection_query_parameters)
Counts ledger types
...
> models::EmptyEnvelope patch_ledger_type_async(tenant_id, ledger_type_id, api_version, x_api_version, patch_operation)
