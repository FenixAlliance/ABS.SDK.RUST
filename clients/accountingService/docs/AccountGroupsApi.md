...
> models::AccountGroupDtoListEnvelope get_account_groups(tenant_id, api_version, x_api_version, account_group_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**account_group_dto_collection_query_parameters** | Option<[**AccountGroupDtoCollectionQueryParameters**](AccountGroupDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_account_groups_count_async(tenant_id, api_version, x_api_version, account_group_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_account_group_async(tenant_id, account_group_id, api_version, x_api_version, patch_operation)
