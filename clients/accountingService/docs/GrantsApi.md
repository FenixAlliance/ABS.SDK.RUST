...
> models::GrantDtoIReadOnlyListEnvelope get_grants_async(tenant_id, api_version, x_api_version, grant_dto_collection_query_parameters)
Get all grants
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**grant_dto_collection_query_parameters** | Option<[**GrantDtoCollectionQueryParameters**](GrantDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_grants_count_async(tenant_id, api_version, x_api_version, grant_dto_collection_query_parameters)
Count grants
...
> models::EmptyEnvelope patch_grant_async(tenant_id, grant_id, api_version, x_api_version, patch_operation)
Patch a grant
