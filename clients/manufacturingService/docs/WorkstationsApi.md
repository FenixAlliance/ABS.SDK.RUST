...
> models::WorkstationDtoListEnvelope get_workstations_async(tenant_id, api_version, x_api_version, workstation_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**workstation_dto_collection_query_parameters** | Option<[**WorkstationDtoCollectionQueryParameters**](WorkstationDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_workstations_count_async(tenant_id, api_version, x_api_version, workstation_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_workstation_async(tenant_id, id, api_version, x_api_version, patch_operation)
Patch a workstation
