...
> models::WorkOrderDtoListEnvelope get_work_orders_async(tenant_id, api_version, x_api_version, work_order_dto_collection_query_parameters)
Get all work orders
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**work_order_dto_collection_query_parameters** | Option<[**WorkOrderDtoCollectionQueryParameters**](WorkOrderDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_work_orders_count_async(tenant_id, api_version, x_api_version, work_order_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_work_order_async(tenant_id, id, api_version, x_api_version, patch_operation)
Patch a work order
