...
> models::WorkOrderTypeDtoListEnvelope get_work_order_types_async(tenant_id, api_version, x_api_version, work_order_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**work_order_type_dto_collection_query_parameters** | Option<[**WorkOrderTypeDtoCollectionQueryParameters**](WorkOrderTypeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_work_order_types_count_async(tenant_id, api_version, x_api_version, work_order_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_work_order_type_async(tenant_id, id, api_version, x_api_version, patch_operation)
