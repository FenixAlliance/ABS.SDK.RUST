...
pub struct ProductionPlanDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProductionPlanDto>>>,
}

impl ProductionPlanDtoListEnvelope {
    pub fn new() -> ProductionPlanDtoListEnvelope {
