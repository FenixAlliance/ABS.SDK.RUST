...
pub struct WorkOrderTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WorkOrderTypeDto>>>,
}

impl WorkOrderTypeDtoListEnvelope {
    pub fn new() -> WorkOrderTypeDtoListEnvelope {
