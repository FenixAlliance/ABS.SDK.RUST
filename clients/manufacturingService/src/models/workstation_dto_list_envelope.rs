...
pub struct WorkstationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WorkstationDto>>>,
}

impl WorkstationDtoListEnvelope {
    pub fn new() -> WorkstationDtoListEnvelope {
