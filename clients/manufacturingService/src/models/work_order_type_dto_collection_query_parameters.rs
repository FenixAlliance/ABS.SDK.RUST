...
pub struct WorkOrderTypeDtoCollectionQueryParameters {
...
impl WorkOrderTypeDtoCollectionQueryParameters {
    pub fn new() -> WorkOrderTypeDtoCollectionQueryParameters {
