...
pub async fn get_message(configuration: &configuration::Configuration, api_version: Option<&str>, x_api_version: Option<&str>) -> Result<(), Error<GetMessageError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v2/IdentityService/Resource/message", local_var_configuration.base_path);
