...
pub struct OpenIdConfigurationEnvelope {
    ...
    pub result: Option<Box<models::OpenIdConfiguration>>,
}

impl OpenIdConfigurationEnvelope {
    pub fn new() -> OpenIdConfigurationEnvelope {
