...
pub struct CourseLibraryDtoCollectionQueryParameters {
...
impl CourseLibraryDtoCollectionQueryParameters {
    pub fn new() -> CourseLibraryDtoCollectionQueryParameters {
