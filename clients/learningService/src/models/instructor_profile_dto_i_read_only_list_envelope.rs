...
pub struct InstructorProfileDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InstructorProfileDto>>>,
}

impl InstructorProfileDtoIReadOnlyListEnvelope {
    pub fn new() -> InstructorProfileDtoIReadOnlyListEnvelope {
