...
pub struct CourseEnrollmentDtoCollectionQueryParameters {
...
impl CourseEnrollmentDtoCollectionQueryParameters {
    pub fn new() -> CourseEnrollmentDtoCollectionQueryParameters {
