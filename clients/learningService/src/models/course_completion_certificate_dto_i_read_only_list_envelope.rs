...
pub struct CourseCompletionCertificateDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CourseCompletionCertificateDto>>>,
}

impl CourseCompletionCertificateDtoIReadOnlyListEnvelope {
    pub fn new() -> CourseCompletionCertificateDtoIReadOnlyListEnvelope {
