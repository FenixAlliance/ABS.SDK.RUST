...
pub struct CourseArticleDtoCollectionQueryParameters {
...
impl CourseArticleDtoCollectionQueryParameters {
    pub fn new() -> CourseArticleDtoCollectionQueryParameters {
