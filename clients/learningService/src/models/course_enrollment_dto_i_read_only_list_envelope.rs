...
pub struct CourseEnrollmentDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CourseEnrollmentDto>>>,
}

impl CourseEnrollmentDtoIReadOnlyListEnvelope {
    pub fn new() -> CourseEnrollmentDtoIReadOnlyListEnvelope {
