...
pub struct StudentProfileDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::StudentProfileDto>>>,
}

impl StudentProfileDtoIReadOnlyListEnvelope {
    pub fn new() -> StudentProfileDtoIReadOnlyListEnvelope {
