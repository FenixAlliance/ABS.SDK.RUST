...
pub struct CourseCategoryDtoCollectionQueryParameters {
...
impl CourseCategoryDtoCollectionQueryParameters {
    pub fn new() -> CourseCategoryDtoCollectionQueryParameters {
