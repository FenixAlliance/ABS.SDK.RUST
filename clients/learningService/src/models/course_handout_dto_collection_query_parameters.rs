...
pub struct CourseHandoutDtoCollectionQueryParameters {
...
impl CourseHandoutDtoCollectionQueryParameters {
    pub fn new() -> CourseHandoutDtoCollectionQueryParameters {
