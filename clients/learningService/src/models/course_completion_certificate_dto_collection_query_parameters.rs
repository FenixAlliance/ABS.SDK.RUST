...
pub struct CourseCompletionCertificateDtoCollectionQueryParameters {
...
impl CourseCompletionCertificateDtoCollectionQueryParameters {
    pub fn new() -> CourseCompletionCertificateDtoCollectionQueryParameters {
