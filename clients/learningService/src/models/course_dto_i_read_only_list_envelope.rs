...
pub struct CourseDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CourseDto>>>,
}

impl CourseDtoIReadOnlyListEnvelope {
    pub fn new() -> CourseDtoIReadOnlyListEnvelope {
