...
> Vec<models::CourseCohortDto> get_course_cohorts_async(tenant_id, api_version, x_api_version, course_cohort_dto_collection_query_parameters)
...
> i32 get_course_cohorts_count_async(tenant_id, api_version, x_api_version, course_cohort_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_cohort_async(tenant_id, cohort_id, api_version, x_api_version, patch_operation)
