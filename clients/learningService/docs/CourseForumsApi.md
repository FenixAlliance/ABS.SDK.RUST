...
> Vec<models::CourseForumDto> get_course_forums_async(tenant_id, api_version, x_api_version, course_forum_dto_collection_query_parameters)
...
> i32 get_course_forums_count_async(tenant_id, api_version, x_api_version, course_forum_dto_collection_query_parameters)
...
> patch_course_forum_async(tenant_id, forum_id, api_version, x_api_version, patch_operation)
