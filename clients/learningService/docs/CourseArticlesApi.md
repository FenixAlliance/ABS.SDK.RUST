...
> Vec<models::CourseArticleDto> get_course_articles_async(tenant_id, api_version, x_api_version, course_article_dto_collection_query_parameters)
...
> i32 get_course_articles_count_async(tenant_id, api_version, x_api_version, course_article_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_article_async(tenant_id, article_id, api_version, x_api_version, patch_operation)
