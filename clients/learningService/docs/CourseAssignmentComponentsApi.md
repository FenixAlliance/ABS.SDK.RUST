...
> Vec<models::CourseAssignmentComponentDto> get_course_assignment_components_async(tenant_id, api_version, x_api_version, course_assignment_component_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**course_assignment_component_dto_collection_query_parameters** | Option<[**CourseAssignmentComponentDtoCollectionQueryParameters**](CourseAssignmentComponentDtoCollectionQueryParameters.md)> |  |  |
...
> i32 get_course_assignment_components_count_async(tenant_id, api_version, x_api_version, course_assignment_component_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_assignment_component_async(tenant_id, component_id, api_version, x_api_version, patch_operation)
