...
> Vec<models::CourseUnitComponentDto> get_course_unit_components_async(tenant_id, api_version, x_api_version, course_unit_component_dto_collection_query_parameters)
...
> i32 get_course_unit_components_count_async(tenant_id, api_version, x_api_version, course_unit_component_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_unit_component_async(tenant_id, component_id, api_version, x_api_version, patch_operation)
