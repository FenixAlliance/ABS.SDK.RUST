...
> Vec<models::CourseAssignmentTypeDto> get_course_assignment_types_async(tenant_id, api_version, x_api_version, course_assignment_type_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**course_assignment_type_dto_collection_query_parameters** | Option<[**CourseAssignmentTypeDtoCollectionQueryParameters**](CourseAssignmentTypeDtoCollectionQueryParameters.md)> |  |  |
...
> i32 get_course_assignment_types_count_async(tenant_id, api_version, x_api_version, course_assignment_type_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_assignment_type_async(tenant_id, assignment_type_id, api_version, x_api_version, patch_operation)
