...
> Vec<models::CourseHandoutDto> get_course_handouts_async(tenant_id, api_version, x_api_version, course_handout_dto_collection_query_parameters)
...
> i32 get_course_handouts_count_async(tenant_id, api_version, x_api_version, course_handout_dto_collection_query_parameters)
...
> patch_course_handout_async(tenant_id, handout_id, api_version, x_api_version, patch_operation)
