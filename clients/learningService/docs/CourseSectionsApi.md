...
> Vec<models::CourseSectionDto> get_course_sections_async(tenant_id, api_version, x_api_version, course_section_dto_collection_query_parameters)
...
> i32 get_course_sections_count_async(tenant_id, api_version, x_api_version, course_section_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_course_section_async(tenant_id, section_id, api_version, x_api_version, patch_operation)
