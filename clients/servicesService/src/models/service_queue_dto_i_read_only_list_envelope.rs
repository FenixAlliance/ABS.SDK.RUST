...
pub struct ServiceQueueDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceQueueDto>>>,
}

impl ServiceQueueDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceQueueDtoIReadOnlyListEnvelope {
