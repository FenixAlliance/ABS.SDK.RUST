...
pub struct ServiceCaseTypeDtoCollectionQueryParameters {
...
impl ServiceCaseTypeDtoCollectionQueryParameters {
    pub fn new() -> ServiceCaseTypeDtoCollectionQueryParameters {
