...
pub struct ServiceCaseTypeDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceCaseTypeDto>>>,
}

impl ServiceCaseTypeDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceCaseTypeDtoIReadOnlyListEnvelope {
