...
pub struct ServiceCaseTypeDtoEnvelope {
    ...
    pub result: Option<Box<models::ServiceCaseTypeDto>>,
}

impl ServiceCaseTypeDtoEnvelope {
    pub fn new() -> ServiceCaseTypeDtoEnvelope {
