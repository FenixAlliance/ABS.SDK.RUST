...
pub struct ServiceCaseDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceCaseDto>>>,
}

impl ServiceCaseDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceCaseDtoIReadOnlyListEnvelope {
