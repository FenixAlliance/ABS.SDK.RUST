...
pub struct ServiceDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceDto>>>,
}

impl ServiceDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceDtoIReadOnlyListEnvelope {
