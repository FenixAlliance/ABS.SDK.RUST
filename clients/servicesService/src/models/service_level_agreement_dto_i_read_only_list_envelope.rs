...
pub struct ServiceLevelAgreementDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceLevelAgreementDto>>>,
}

impl ServiceLevelAgreementDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceLevelAgreementDtoIReadOnlyListEnvelope {
