...
pub struct ServiceLevelAgreementDtoEnvelope {
    ...
    pub result: Option<Box<models::ServiceLevelAgreementDto>>,
}

impl ServiceLevelAgreementDtoEnvelope {
    pub fn new() -> ServiceLevelAgreementDtoEnvelope {
