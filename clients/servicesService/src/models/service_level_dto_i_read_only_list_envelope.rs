...
pub struct ServiceLevelDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ServiceLevelDto>>>,
}

impl ServiceLevelDtoIReadOnlyListEnvelope {
    pub fn new() -> ServiceLevelDtoIReadOnlyListEnvelope {
