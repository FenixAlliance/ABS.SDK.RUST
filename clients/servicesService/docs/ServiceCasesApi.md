...
> models::ServiceCaseDtoIReadOnlyListEnvelope get_service_cases_async(tenant_id, api_version, x_api_version, service_case_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**service_case_dto_collection_query_parameters** | Option<[**ServiceCaseDtoCollectionQueryParameters**](ServiceCaseDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_service_cases_count_async(tenant_id, api_version, x_api_version, service_case_dto_collection_query_parameters)
...
> models::Envelope patch_service_case_async(tenant_id, service_case_id, api_version, x_api_version, patch_operation)
