...
> models::JobApplicantProfileDtoListEnvelope get_job_applicants_async(tenant_id, api_version, x_api_version)
Get job applicants
...
> models::Int32Envelope get_job_applicants_count_async(tenant_id, api_version, x_api_version)
...
> models::EmptyEnvelope patch_job_applicant_async(tenant_id, job_applicant_id, api_version, x_api_version, operation)
