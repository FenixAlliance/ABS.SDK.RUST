...
> models::JobFieldDtoListEnvelope get_job_fields_async(tenant_id, api_version, x_api_version, job_field_dto_collection_query_parameters)
Get job fields
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**job_field_dto_collection_query_parameters** | Option<[**JobFieldDtoCollectionQueryParameters**](JobFieldDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_job_fields_count_async(tenant_id, api_version, x_api_version, job_field_dto_collection_query_parameters)
Count job fields
...
> models::EmptyEnvelope patch_job_field_async(tenant_id, job_field_id, api_version, x_api_version, patch_operation)
Patch a job field
