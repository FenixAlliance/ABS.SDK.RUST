...
> models::TimeIntervalDtoListEnvelope get_time_intervals_async(tenant_id, api_version, x_api_version, time_interval_dto_collection_query_parameters)
Get time intervals
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**time_interval_dto_collection_query_parameters** | Option<[**TimeIntervalDtoCollectionQueryParameters**](TimeIntervalDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_time_intervals_count_async(tenant_id, api_version, x_api_version, time_interval_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_time_interval_async(tenant_id, time_interval_id, api_version, x_api_version, patch_operation)
