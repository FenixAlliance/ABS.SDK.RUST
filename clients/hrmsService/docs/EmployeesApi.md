...
> models::EmployeeProfileDtoListEnvelope get_employees_async(tenant_id, api_version, x_api_version, employee_profile_dto_collection_query_parameters)
Get employees
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**employee_profile_dto_collection_query_parameters** | Option<[**EmployeeProfileDtoCollectionQueryParameters**](EmployeeProfileDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_employees_count_async(tenant_id, api_version, x_api_version, employee_profile_dto_collection_query_parameters)
Count employees
...
> models::EmptyEnvelope patch_employee_async(tenant_id, employee_id, api_version, x_api_version, patch_operation)
Patch an employee
