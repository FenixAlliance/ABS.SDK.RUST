...
> models::SalaryDtoListEnvelope get_salaries_async(tenant_id, api_version, x_api_version, salary_dto_collection_query_parameters)
Get salaries
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**salary_dto_collection_query_parameters** | Option<[**SalaryDtoCollectionQueryParameters**](SalaryDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_salaries_count_async(tenant_id, api_version, x_api_version, salary_dto_collection_query_parameters)
Count salaries
...
> models::EmptyEnvelope patch_salary_async(tenant_id, salary_id, api_version, x_api_version, patch_operation)
Patch a salary
