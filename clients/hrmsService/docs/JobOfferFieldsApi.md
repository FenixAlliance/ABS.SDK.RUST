...
> models::JobOfferFieldRecordDtoListEnvelope get_job_offer_fields_async(tenant_id, api_version, x_api_version)
...
> models::Int32Envelope get_job_offer_fields_count_async(tenant_id, api_version, x_api_version)
...
> models::EmptyEnvelope patch_job_offer_field_async(tenant_id, job_offer_field_id, api_version, x_api_version, operation)
