...
> models::AppraisalStageDtoListEnvelope get_appraisal_stages_async(tenant_id, api_version, x_api_version, appraisal_stage_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**appraisal_stage_dto_collection_query_parameters** | Option<[**AppraisalStageDtoCollectionQueryParameters**](AppraisalStageDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_appraisal_stages_count_async(tenant_id, api_version, x_api_version, appraisal_stage_dto_collection_query_parameters)
