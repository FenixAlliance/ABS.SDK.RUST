...
> models::PayrollDtoListEnvelope get_payrolls_async(tenant_id, api_version, x_api_version, payroll_dto_collection_query_parameters)
Get payrolls
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**payroll_dto_collection_query_parameters** | Option<[**PayrollDtoCollectionQueryParameters**](PayrollDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_payrolls_count_async(tenant_id, api_version, x_api_version, payroll_dto_collection_query_parameters)
Count payrolls
...
> models::EmptyEnvelope patch_payroll_async(tenant_id, payroll_id, api_version, x_api_version, patch_operation)
Patch a payroll
