...
> models::GigDtoListEnvelope get_gigs_async(tenant_id, api_version, x_api_version, gig_dto_collection_query_parameters)
Get gigs
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**gig_dto_collection_query_parameters** | Option<[**GigDtoCollectionQueryParameters**](GigDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_gigs_count_async(tenant_id, api_version, x_api_version, gig_dto_collection_query_parameters)
Count gigs
...
> models::EmptyEnvelope patch_gig_async(tenant_id, gig_id, api_version, x_api_version, patch_operation)
Patch a gig
