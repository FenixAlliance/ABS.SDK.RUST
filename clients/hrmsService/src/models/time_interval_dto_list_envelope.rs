...
pub struct TimeIntervalDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TimeIntervalDto>>>,
}

impl TimeIntervalDtoListEnvelope {
    pub fn new() -> TimeIntervalDtoListEnvelope {
