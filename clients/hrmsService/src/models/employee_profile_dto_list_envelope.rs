...
pub struct EmployeeProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmployeeProfileDto>>>,
}

impl EmployeeProfileDtoListEnvelope {
    pub fn new() -> EmployeeProfileDtoListEnvelope {
