...
pub struct LeaveApplicationDtoEnvelope {
    ...
    pub result: Option<Box<models::LeaveApplicationDto>>,
}

impl LeaveApplicationDtoEnvelope {
    pub fn new() -> LeaveApplicationDtoEnvelope {
