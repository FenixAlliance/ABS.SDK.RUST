...
pub struct EmployeeProfileDtoCollectionQueryParameters {
...
impl EmployeeProfileDtoCollectionQueryParameters {
    pub fn new() -> EmployeeProfileDtoCollectionQueryParameters {
