...
pub struct JobOfferFieldRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::JobOfferFieldRecordDto>>,
}

impl JobOfferFieldRecordDtoEnvelope {
    pub fn new() -> JobOfferFieldRecordDtoEnvelope {
