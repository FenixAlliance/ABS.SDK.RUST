...
pub struct AppraisalStageDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AppraisalStageDto>>>,
}

impl AppraisalStageDtoListEnvelope {
    pub fn new() -> AppraisalStageDtoListEnvelope {
