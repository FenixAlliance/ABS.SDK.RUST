...
pub struct AppraisalWorkflowDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AppraisalWorkflowDto>>>,
}

impl AppraisalWorkflowDtoListEnvelope {
    pub fn new() -> AppraisalWorkflowDtoListEnvelope {
