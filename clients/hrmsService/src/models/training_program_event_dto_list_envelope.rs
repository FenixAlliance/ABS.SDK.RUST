...
pub struct TrainingProgramEventDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TrainingProgramEventDto>>>,
}

impl TrainingProgramEventDtoListEnvelope {
    pub fn new() -> TrainingProgramEventDtoListEnvelope {
