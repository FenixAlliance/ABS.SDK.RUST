...
pub struct GigApplicationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::GigApplicationDto>>>,
}

impl GigApplicationDtoListEnvelope {
    pub fn new() -> GigApplicationDtoListEnvelope {
