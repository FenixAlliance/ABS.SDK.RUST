...
pub struct EmployerProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmployerProfileDto>>>,
}

impl EmployerProfileDtoListEnvelope {
    pub fn new() -> EmployerProfileDtoListEnvelope {
