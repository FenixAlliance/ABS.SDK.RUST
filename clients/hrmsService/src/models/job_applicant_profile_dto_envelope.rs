...
pub struct JobApplicantProfileDtoEnvelope {
    ...
    pub result: Option<Box<models::JobApplicantProfileDto>>,
}

impl JobApplicantProfileDtoEnvelope {
    pub fn new() -> JobApplicantProfileDtoEnvelope {
