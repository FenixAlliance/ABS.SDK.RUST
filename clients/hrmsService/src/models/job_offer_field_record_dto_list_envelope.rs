...
pub struct JobOfferFieldRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JobOfferFieldRecordDto>>>,
}

impl JobOfferFieldRecordDtoListEnvelope {
    pub fn new() -> JobOfferFieldRecordDtoListEnvelope {
