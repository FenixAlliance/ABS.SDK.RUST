...
pub struct TrainingProgramCourseDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TrainingProgramCourseDto>>>,
}

impl TrainingProgramCourseDtoListEnvelope {
    pub fn new() -> TrainingProgramCourseDtoListEnvelope {
