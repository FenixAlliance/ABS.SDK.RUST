...
pub struct EmployeeProfileDtoEnvelope {
    ...
    pub result: Option<Box<models::EmployeeProfileDto>>,
}

impl EmployeeProfileDtoEnvelope {
    pub fn new() -> EmployeeProfileDtoEnvelope {
