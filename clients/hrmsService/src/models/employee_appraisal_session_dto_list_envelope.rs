...
pub struct EmployeeAppraisalSessionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmployeeAppraisalSessionDto>>>,
}

impl EmployeeAppraisalSessionDtoListEnvelope {
    pub fn new() -> EmployeeAppraisalSessionDtoListEnvelope {
