...
pub struct EmployerProfileDtoCollectionQueryParameters {
...
impl EmployerProfileDtoCollectionQueryParameters {
    pub fn new() -> EmployerProfileDtoCollectionQueryParameters {
