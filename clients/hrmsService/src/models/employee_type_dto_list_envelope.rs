...
pub struct EmployeeTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::EmployeeTypeDto>>>,
}

impl EmployeeTypeDtoListEnvelope {
    pub fn new() -> EmployeeTypeDtoListEnvelope {
