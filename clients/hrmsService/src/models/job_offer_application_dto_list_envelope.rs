...
pub struct JobOfferApplicationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JobOfferApplicationDto>>>,
}

impl JobOfferApplicationDtoListEnvelope {
    pub fn new() -> JobOfferApplicationDtoListEnvelope {
