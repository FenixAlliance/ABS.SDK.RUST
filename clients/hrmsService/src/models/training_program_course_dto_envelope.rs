...
pub struct TrainingProgramCourseDtoEnvelope {
    ...
    pub result: Option<Box<models::TrainingProgramCourseDto>>,
}

impl TrainingProgramCourseDtoEnvelope {
    pub fn new() -> TrainingProgramCourseDtoEnvelope {
