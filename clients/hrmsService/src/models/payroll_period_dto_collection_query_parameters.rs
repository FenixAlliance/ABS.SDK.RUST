...
pub struct PayrollPeriodDtoCollectionQueryParameters {
...
impl PayrollPeriodDtoCollectionQueryParameters {
    pub fn new() -> PayrollPeriodDtoCollectionQueryParameters {
