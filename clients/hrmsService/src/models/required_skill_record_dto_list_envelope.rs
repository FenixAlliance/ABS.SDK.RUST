...
pub struct RequiredSkillRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::RequiredSkillRecordDto>>>,
}

impl RequiredSkillRecordDtoListEnvelope {
    pub fn new() -> RequiredSkillRecordDtoListEnvelope {
