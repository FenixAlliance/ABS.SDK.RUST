...
pub struct TrainingProgramDtoEnvelope {
    ...
    pub result: Option<Box<models::TrainingProgramDto>>,
}

impl TrainingProgramDtoEnvelope {
    pub fn new() -> TrainingProgramDtoEnvelope {
