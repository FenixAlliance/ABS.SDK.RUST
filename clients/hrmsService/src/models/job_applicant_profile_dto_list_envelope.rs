...
pub struct JobApplicantProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::JobApplicantProfileDto>>>,
}

impl JobApplicantProfileDtoListEnvelope {
    pub fn new() -> JobApplicantProfileDtoListEnvelope {
