...
pub struct LeaveApplicationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LeaveApplicationDto>>>,
}

impl LeaveApplicationDtoListEnvelope {
    pub fn new() -> LeaveApplicationDtoListEnvelope {
