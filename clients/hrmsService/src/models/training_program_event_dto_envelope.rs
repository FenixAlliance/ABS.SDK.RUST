...
pub struct TrainingProgramEventDtoEnvelope {
    ...
    pub result: Option<Box<models::TrainingProgramEventDto>>,
}

impl TrainingProgramEventDtoEnvelope {
    pub fn new() -> TrainingProgramEventDtoEnvelope {
