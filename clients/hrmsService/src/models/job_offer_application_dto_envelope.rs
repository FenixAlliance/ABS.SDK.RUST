...
pub struct JobOfferApplicationDtoEnvelope {
    ...
    pub result: Option<Box<models::JobOfferApplicationDto>>,
}

impl JobOfferApplicationDtoEnvelope {
    pub fn new() -> JobOfferApplicationDtoEnvelope {
