...
pub struct EmployeeAppraisalSessionDtoEnvelope {
    ...
    pub result: Option<Box<models::EmployeeAppraisalSessionDto>>,
}

impl EmployeeAppraisalSessionDtoEnvelope {
    pub fn new() -> EmployeeAppraisalSessionDtoEnvelope {
