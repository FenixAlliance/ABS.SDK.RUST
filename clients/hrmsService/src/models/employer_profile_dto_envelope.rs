...
pub struct EmployerProfileDtoEnvelope {
    ...
    pub result: Option<Box<models::EmployerProfileDto>>,
}

impl EmployerProfileDtoEnvelope {
    pub fn new() -> EmployerProfileDtoEnvelope {
