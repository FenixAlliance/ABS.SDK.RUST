...
pub struct PayrollPeriodDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PayrollPeriodDto>>>,
}

impl PayrollPeriodDtoListEnvelope {
    pub fn new() -> PayrollPeriodDtoListEnvelope {
