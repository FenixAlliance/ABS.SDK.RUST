...
pub struct AppraisalWorkflowDtoEnvelope {
    ...
    pub result: Option<Box<models::AppraisalWorkflowDto>>,
}

impl AppraisalWorkflowDtoEnvelope {
    pub fn new() -> AppraisalWorkflowDtoEnvelope {
