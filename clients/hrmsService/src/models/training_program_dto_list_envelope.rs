...
pub struct TrainingProgramDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TrainingProgramDto>>>,
}

impl TrainingProgramDtoListEnvelope {
    pub fn new() -> TrainingProgramDtoListEnvelope {
