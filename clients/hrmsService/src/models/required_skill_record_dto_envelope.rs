...
pub struct RequiredSkillRecordDtoEnvelope {
    ...
    pub result: Option<Box<models::RequiredSkillRecordDto>>,
}

impl RequiredSkillRecordDtoEnvelope {
    pub fn new() -> RequiredSkillRecordDtoEnvelope {
