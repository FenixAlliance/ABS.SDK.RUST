...
pub struct GigApplicationDtoCollectionQueryParameters {
...
impl GigApplicationDtoCollectionQueryParameters {
    pub fn new() -> GigApplicationDtoCollectionQueryParameters {
