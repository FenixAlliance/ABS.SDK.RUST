...
pub struct SecurityPermissionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SecurityPermissionDto>>>,
}

impl SecurityPermissionDtoListEnvelope {
    pub fn new() -> SecurityPermissionDtoListEnvelope {
