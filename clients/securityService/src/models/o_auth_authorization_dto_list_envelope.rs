...
pub struct OAuthAuthorizationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::OAuthAuthorizationDto>>>,
}

impl OAuthAuthorizationDtoListEnvelope {
    pub fn new() -> OAuthAuthorizationDtoListEnvelope {
