...
pub struct BusinessSecurityLogDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BusinessSecurityLogDto>>>,
}

impl BusinessSecurityLogDtoListEnvelope {
    pub fn new() -> BusinessSecurityLogDtoListEnvelope {
