...
pub struct OAuthAuthorizationDtoEnvelope {
    ...
    pub result: Option<Box<models::OAuthAuthorizationDto>>,
}

impl OAuthAuthorizationDtoEnvelope {
    pub fn new() -> OAuthAuthorizationDtoEnvelope {
