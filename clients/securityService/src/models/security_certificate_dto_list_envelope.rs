...
pub struct SecurityCertificateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SecurityCertificateDto>>>,
}

impl SecurityCertificateDtoListEnvelope {
    pub fn new() -> SecurityCertificateDtoListEnvelope {
