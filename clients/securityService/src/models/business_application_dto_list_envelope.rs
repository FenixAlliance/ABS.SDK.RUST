...
pub struct BusinessApplicationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BusinessApplicationDto>>>,
}

impl BusinessApplicationDtoListEnvelope {
    pub fn new() -> BusinessApplicationDtoListEnvelope {
