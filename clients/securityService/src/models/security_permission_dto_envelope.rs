...
pub struct SecurityPermissionDtoEnvelope {
    ...
    pub result: Option<Box<models::SecurityPermissionDto>>,
}

impl SecurityPermissionDtoEnvelope {
    pub fn new() -> SecurityPermissionDtoEnvelope {
