...
pub struct WebhookRequestDtoCollectionQueryParameters {
...
impl WebhookRequestDtoCollectionQueryParameters {
    pub fn new() -> WebhookRequestDtoCollectionQueryParameters {
