...
pub struct ApplicationPrincipalProvisioningResultDtoEnvelope {
    ...
    pub result: Option<Box<models::ApplicationPrincipalProvisioningResultDto>>,
}

impl ApplicationPrincipalProvisioningResultDtoEnvelope {
    pub fn new() -> ApplicationPrincipalProvisioningResultDtoEnvelope {
