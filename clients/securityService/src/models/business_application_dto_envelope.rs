...
pub struct BusinessApplicationDtoEnvelope {
    ...
    pub result: Option<Box<models::BusinessApplicationDto>>,
}

impl BusinessApplicationDtoEnvelope {
    pub fn new() -> BusinessApplicationDtoEnvelope {
