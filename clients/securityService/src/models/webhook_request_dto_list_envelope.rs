...
pub struct WebhookRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WebhookRequestDto>>>,
}

impl WebhookRequestDtoListEnvelope {
    pub fn new() -> WebhookRequestDtoListEnvelope {
