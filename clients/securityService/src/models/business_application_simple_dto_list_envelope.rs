...
pub struct BusinessApplicationSimpleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BusinessApplicationSimpleDto>>>,
}

impl BusinessApplicationSimpleDtoListEnvelope {
    pub fn new() -> BusinessApplicationSimpleDtoListEnvelope {
