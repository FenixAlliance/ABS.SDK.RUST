...
pub struct OAuthApplicationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::OAuthApplicationDto>>>,
}

impl OAuthApplicationDtoListEnvelope {
    pub fn new() -> OAuthApplicationDtoListEnvelope {
