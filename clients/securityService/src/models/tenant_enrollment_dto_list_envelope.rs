...
pub struct TenantEnrollmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TenantEnrollmentDto>>>,
}

impl TenantEnrollmentDtoListEnvelope {
    pub fn new() -> TenantEnrollmentDtoListEnvelope {
