...
pub struct OAuthApplicationDtoEnvelope {
    ...
    pub result: Option<Box<models::OAuthApplicationDto>>,
}

impl OAuthApplicationDtoEnvelope {
    pub fn new() -> OAuthApplicationDtoEnvelope {
