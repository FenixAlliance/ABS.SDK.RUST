...
pub struct SecurityRoleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SecurityRoleDto>>>,
}

impl SecurityRoleDtoListEnvelope {
    pub fn new() -> SecurityRoleDtoListEnvelope {
