...
> models::WebhookRequestDtoListEnvelope get_webhook_requests_async(tenant_id, api_version, x_api_version, webhook_request_dto_collection_query_parameters)
...
**webhook_request_dto_collection_query_parameters** | Option<[**WebhookRequestDtoCollectionQueryParameters**](WebhookRequestDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_webhook_requests_count_async(tenant_id, api_version, x_api_version, webhook_request_dto_collection_query_parameters)
