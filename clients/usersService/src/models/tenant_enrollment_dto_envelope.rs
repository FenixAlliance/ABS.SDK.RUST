...
pub struct TenantEnrollmentDtoEnvelope {
    ...
    pub result: Option<Box<models::TenantEnrollmentDto>>,
}

impl TenantEnrollmentDtoEnvelope {
    pub fn new() -> TenantEnrollmentDtoEnvelope {
