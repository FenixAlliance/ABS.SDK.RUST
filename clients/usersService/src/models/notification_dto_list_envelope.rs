...
pub struct NotificationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::NotificationDto>>>,
}

impl NotificationDtoListEnvelope {
    pub fn new() -> NotificationDtoListEnvelope {
