...
pub struct ExtendedTenantEnrollmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedTenantEnrollmentDto>>>,
}

impl ExtendedTenantEnrollmentDtoListEnvelope {
    pub fn new() -> ExtendedTenantEnrollmentDtoListEnvelope {
