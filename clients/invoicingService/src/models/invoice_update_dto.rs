...
pub struct InvoiceUpdateDto {
    ...
    #[serde(rename = "validTo", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub valid_to: Option<Option<String>>,
    #[serde(rename = "invoiceLines", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invoice_lines: Option<Option<Vec<models::InvoiceLineCreateDto>>>,
    #[serde(rename = "invoiceReferences", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invoice_references: Option<Option<Vec<models::InvoiceReferenceCreateDto>>>,
    #[serde(rename = "invoiceAdjustments", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invoice_adjustments: Option<Option<Vec<models::InvoiceAdjustmentCreateDto>>>,
}

impl InvoiceUpdateDto {
    pub fn new() -> InvoiceUpdateDto {
        InvoiceUpdateDto {
            closed: None,
            title: None,
            user_id: None,
