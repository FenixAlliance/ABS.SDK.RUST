...
pub struct InvoiceReferenceDtoEnvelope {
    ...
    pub result: Option<Box<models::InvoiceReferenceDto>>,
}

impl InvoiceReferenceDtoEnvelope {
    pub fn new() -> InvoiceReferenceDtoEnvelope {
