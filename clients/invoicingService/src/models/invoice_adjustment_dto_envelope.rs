...
pub struct InvoiceAdjustmentDtoEnvelope {
    ...
    pub result: Option<Box<models::InvoiceAdjustmentDto>>,
}

impl InvoiceAdjustmentDtoEnvelope {
    pub fn new() -> InvoiceAdjustmentDtoEnvelope {
