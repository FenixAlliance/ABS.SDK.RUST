...
pub struct ExtendedInvoiceDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedInvoiceDto>>>,
}

impl ExtendedInvoiceDtoListEnvelope {
    pub fn new() -> ExtendedInvoiceDtoListEnvelope {
