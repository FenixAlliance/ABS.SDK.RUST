...
pub struct InvoiceAdjustmentDtoCollectionQueryParameters {
...
impl InvoiceAdjustmentDtoCollectionQueryParameters {
    pub fn new() -> InvoiceAdjustmentDtoCollectionQueryParameters {
