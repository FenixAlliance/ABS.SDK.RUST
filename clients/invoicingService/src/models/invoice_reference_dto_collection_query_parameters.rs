...
pub struct InvoiceReferenceDtoCollectionQueryParameters {
...
impl InvoiceReferenceDtoCollectionQueryParameters {
    pub fn new() -> InvoiceReferenceDtoCollectionQueryParameters {
