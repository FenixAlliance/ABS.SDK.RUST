...
pub struct InvoiceAdjustmentDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InvoiceAdjustmentDto>>>,
}

impl InvoiceAdjustmentDtoIReadOnlyListEnvelope {
    pub fn new() -> InvoiceAdjustmentDtoIReadOnlyListEnvelope {
