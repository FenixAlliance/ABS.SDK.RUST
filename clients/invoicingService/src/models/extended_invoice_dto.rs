...
pub struct ExtendedInvoiceDto {
    ...
    pub user: Option<Box<models::SimpleUserDto>>,
    ...
    pub individual: Option<Box<models::SimpleContactDto>>,
    #[serde(rename = "organization", skip_serializing_if = "Option::is_none")]
    pub organization: Option<Box<models::SimpleContactDto>>,
    #[serde(rename = "enrollment", skip_serializing_if = "Option::is_none")]
    pub enrollment: Option<Box<models::SimpleTenantEnrollmentDto>>,
    #[serde(rename = "invoiceLines", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub invoice_lines: Option<Option<Vec<models::InvoiceLineDto>>>,
}

impl ExtendedInvoiceDto {
    pub fn new() -> ExtendedInvoiceDto {
        ExtendedInvoiceDto {
            id: None,
            timestamp: None,
            closed: None,
