...
pub struct InvoiceLineDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InvoiceLineDto>>>,
}

impl InvoiceLineDtoIReadOnlyListEnvelope {
    pub fn new() -> InvoiceLineDtoIReadOnlyListEnvelope {
