...
pub struct InvoiceReferenceDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InvoiceReferenceDto>>>,
}

impl InvoiceReferenceDtoIReadOnlyListEnvelope {
    pub fn new() -> InvoiceReferenceDtoIReadOnlyListEnvelope {
