...
pub struct InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InvoiceLineAppliedTaxDto>>>,
}

impl InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope {
    pub fn new() -> InvoiceLineAppliedTaxDtoIReadOnlyListEnvelope {
