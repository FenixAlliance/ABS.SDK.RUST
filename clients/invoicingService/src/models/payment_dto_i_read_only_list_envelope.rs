...
pub struct PaymentDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentDto>>>,
}

impl PaymentDtoIReadOnlyListEnvelope {
    pub fn new() -> PaymentDtoIReadOnlyListEnvelope {
