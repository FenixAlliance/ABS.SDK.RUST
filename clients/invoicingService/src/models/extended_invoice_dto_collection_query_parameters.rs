...
pub struct ExtendedInvoiceDtoCollectionQueryParameters {
...
impl ExtendedInvoiceDtoCollectionQueryParameters {
    pub fn new() -> ExtendedInvoiceDtoCollectionQueryParameters {
