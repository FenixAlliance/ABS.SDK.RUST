...
pub struct CountryLanguageDtoEnvelope {
    ...
    pub result: Option<Box<models::CountryLanguageDto>>,
}

impl CountryLanguageDtoEnvelope {
    pub fn new() -> CountryLanguageDtoEnvelope {
