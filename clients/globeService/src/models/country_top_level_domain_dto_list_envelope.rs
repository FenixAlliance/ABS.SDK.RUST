...
pub struct CountryTopLevelDomainDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CountryTopLevelDomainDto>>>,
}

impl CountryTopLevelDomainDtoListEnvelope {
    pub fn new() -> CountryTopLevelDomainDtoListEnvelope {
