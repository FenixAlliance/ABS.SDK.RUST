...
pub struct CountryCallingCodeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CountryCallingCodeDto>>>,
}

impl CountryCallingCodeDtoListEnvelope {
    pub fn new() -> CountryCallingCodeDtoListEnvelope {
