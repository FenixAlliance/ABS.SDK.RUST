...
pub struct CountryLanguageDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CountryLanguageDto>>>,
}

impl CountryLanguageDtoListEnvelope {
    pub fn new() -> CountryLanguageDtoListEnvelope {
