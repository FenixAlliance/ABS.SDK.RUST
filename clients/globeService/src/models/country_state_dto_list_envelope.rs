...
pub struct CountryStateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CountryStateDto>>>,
}

impl CountryStateDtoListEnvelope {
    pub fn new() -> CountryStateDtoListEnvelope {
