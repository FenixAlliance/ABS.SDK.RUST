...
pub struct TimezoneDto {
    ...
    #[serde(rename = "utcOffset", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub utc_offset: Option<Option<String>>,
    #[serde(rename = "displayName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub display_name: Option<Option<String>>,
}

impl TimezoneDto {
    pub fn new() -> TimezoneDto {
        TimezoneDto {
            id: None,
            timestamp: None,
            name: None,
