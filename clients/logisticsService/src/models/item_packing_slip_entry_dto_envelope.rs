...
pub struct ItemPackingSlipEntryDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemPackingSlipEntryDto>>,
}

impl ItemPackingSlipEntryDtoEnvelope {
    pub fn new() -> ItemPackingSlipEntryDtoEnvelope {
