...
pub struct ProofOfDeliveryLineDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProofOfDeliveryLineDto>>>,
}

impl ProofOfDeliveryLineDtoListEnvelope {
    pub fn new() -> ProofOfDeliveryLineDtoListEnvelope {
