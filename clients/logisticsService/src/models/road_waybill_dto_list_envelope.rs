...
pub struct RoadWaybillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::RoadWaybillDto>>>,
}

impl RoadWaybillDtoListEnvelope {
    pub fn new() -> RoadWaybillDtoListEnvelope {
