...
pub struct ItemPackingSlipDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemPackingSlipDto>>>,
}

impl ItemPackingSlipDtoListEnvelope {
    pub fn new() -> ItemPackingSlipDtoListEnvelope {
