...
pub struct VoyagePortCallDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::VoyagePortCallDto>>>,
}

impl VoyagePortCallDtoListEnvelope {
    pub fn new() -> VoyagePortCallDtoListEnvelope {
