...
pub struct WaybillLineDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WaybillLineDto>>>,
}

impl WaybillLineDtoListEnvelope {
    pub fn new() -> WaybillLineDtoListEnvelope {
