...
pub struct ItemPackingSlipEntryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemPackingSlipEntryDto>>>,
}

impl ItemPackingSlipEntryDtoListEnvelope {
    pub fn new() -> ItemPackingSlipEntryDtoListEnvelope {
