...
pub struct ItemPackingSlipDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemPackingSlipDto>>,
}

impl ItemPackingSlipDtoEnvelope {
    pub fn new() -> ItemPackingSlipDtoEnvelope {
