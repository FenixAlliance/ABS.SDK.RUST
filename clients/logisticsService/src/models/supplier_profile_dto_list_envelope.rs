...
pub struct SupplierProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SupplierProfileDto>>>,
}

impl SupplierProfileDtoListEnvelope {
    pub fn new() -> SupplierProfileDtoListEnvelope {
