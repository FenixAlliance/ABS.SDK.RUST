...
pub struct DeliveryNoteDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::DeliveryNoteDto>>>,
}

impl DeliveryNoteDtoListEnvelope {
    pub fn new() -> DeliveryNoteDtoListEnvelope {
