...
pub struct SeawayBillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SeawayBillDto>>>,
}

impl SeawayBillDtoListEnvelope {
    pub fn new() -> SeawayBillDtoListEnvelope {
