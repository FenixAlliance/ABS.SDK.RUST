...
pub struct ItemRetainSampleDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemRetainSampleDto>>,
}

impl ItemRetainSampleDtoEnvelope {
    pub fn new() -> ItemRetainSampleDtoEnvelope {
