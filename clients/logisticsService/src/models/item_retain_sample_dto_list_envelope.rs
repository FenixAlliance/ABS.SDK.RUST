...
pub struct ItemRetainSampleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemRetainSampleDto>>>,
}

impl ItemRetainSampleDtoListEnvelope {
    pub fn new() -> ItemRetainSampleDtoListEnvelope {
