...
pub struct AirwayBillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AirwayBillDto>>>,
}

impl AirwayBillDtoListEnvelope {
    pub fn new() -> AirwayBillDtoListEnvelope {
