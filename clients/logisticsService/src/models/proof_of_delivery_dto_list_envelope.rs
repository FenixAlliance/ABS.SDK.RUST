...
pub struct ProofOfDeliveryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProofOfDeliveryDto>>>,
}

impl ProofOfDeliveryDtoListEnvelope {
    pub fn new() -> ProofOfDeliveryDtoListEnvelope {
