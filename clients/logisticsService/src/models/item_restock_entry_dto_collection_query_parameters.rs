...
pub struct ItemRestockEntryDtoCollectionQueryParameters {
...
impl ItemRestockEntryDtoCollectionQueryParameters {
    pub fn new() -> ItemRestockEntryDtoCollectionQueryParameters {
