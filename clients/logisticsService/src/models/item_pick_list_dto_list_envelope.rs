...
pub struct ItemPickListDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemPickListDto>>>,
}

impl ItemPickListDtoListEnvelope {
    pub fn new() -> ItemPickListDtoListEnvelope {
