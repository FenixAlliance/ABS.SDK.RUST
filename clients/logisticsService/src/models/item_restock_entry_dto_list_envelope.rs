...
pub struct ItemRestockEntryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemRestockEntryDto>>>,
}

impl ItemRestockEntryDtoListEnvelope {
    pub fn new() -> ItemRestockEntryDtoListEnvelope {
