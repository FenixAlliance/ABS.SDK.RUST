...
pub struct TruckDriverDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TruckDriverDto>>>,
}

impl TruckDriverDtoListEnvelope {
    pub fn new() -> TruckDriverDtoListEnvelope {
