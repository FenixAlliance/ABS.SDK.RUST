...
pub struct ProofOfDeliveryDtoEnvelope {
    ...
    pub result: Option<Box<models::ProofOfDeliveryDto>>,
}

impl ProofOfDeliveryDtoEnvelope {
    pub fn new() -> ProofOfDeliveryDtoEnvelope {
