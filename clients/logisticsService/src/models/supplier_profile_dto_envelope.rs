...
pub struct SupplierProfileDtoEnvelope {
    ...
    pub result: Option<Box<models::SupplierProfileDto>>,
}

impl SupplierProfileDtoEnvelope {
    pub fn new() -> SupplierProfileDtoEnvelope {
