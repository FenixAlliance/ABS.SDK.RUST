...
pub struct ItemPickListEntryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemPickListEntryDto>>>,
}

impl ItemPickListEntryDtoListEnvelope {
    pub fn new() -> ItemPickListEntryDtoListEnvelope {
