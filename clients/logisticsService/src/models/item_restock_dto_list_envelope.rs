...
pub struct ItemRestockDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemRestockDto>>>,
}

impl ItemRestockDtoListEnvelope {
    pub fn new() -> ItemRestockDtoListEnvelope {
