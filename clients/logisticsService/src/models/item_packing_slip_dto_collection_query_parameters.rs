...
pub struct ItemPackingSlipDtoCollectionQueryParameters {
...
impl ItemPackingSlipDtoCollectionQueryParameters {
    pub fn new() -> ItemPackingSlipDtoCollectionQueryParameters {
