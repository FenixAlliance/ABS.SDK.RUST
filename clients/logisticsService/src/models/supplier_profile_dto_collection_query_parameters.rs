...
pub struct SupplierProfileDtoCollectionQueryParameters {
...
impl SupplierProfileDtoCollectionQueryParameters {
    pub fn new() -> SupplierProfileDtoCollectionQueryParameters {
