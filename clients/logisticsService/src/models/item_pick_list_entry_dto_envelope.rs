...
pub struct ItemPickListEntryDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemPickListEntryDto>>,
}

impl ItemPickListEntryDtoEnvelope {
    pub fn new() -> ItemPickListEntryDtoEnvelope {
