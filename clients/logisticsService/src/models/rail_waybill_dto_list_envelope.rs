...
pub struct RailWaybillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::RailWaybillDto>>>,
}

impl RailWaybillDtoListEnvelope {
    pub fn new() -> RailWaybillDtoListEnvelope {
