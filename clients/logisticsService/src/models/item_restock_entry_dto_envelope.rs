...
pub struct ItemRestockEntryDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemRestockEntryDto>>,
}

impl ItemRestockEntryDtoEnvelope {
    pub fn new() -> ItemRestockEntryDtoEnvelope {
