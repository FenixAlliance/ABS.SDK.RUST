...
> models::DeliveryNoteDtoListEnvelope get_delivery_notes_async(tenant_id, api_version, x_api_version, delivery_note_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**delivery_note_dto_collection_query_parameters** | Option<[**DeliveryNoteDtoCollectionQueryParameters**](DeliveryNoteDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_delivery_notes_count_async(tenant_id, api_version, x_api_version, delivery_note_dto_collection_query_parameters)
