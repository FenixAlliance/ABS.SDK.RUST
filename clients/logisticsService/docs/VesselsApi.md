...
> models::VesselDtoListEnvelope get_vessels_async(tenant_id, api_version, x_api_version, vessel_dto_collection_query_parameters)
Get all vessels
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**vessel_dto_collection_query_parameters** | Option<[**VesselDtoCollectionQueryParameters**](VesselDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_vessels_count_async(tenant_id, api_version, x_api_version, vessel_dto_collection_query_parameters)
Get vessels count
...
> models::EmptyEnvelope patch_vessel_async(tenant_id, vessel_id, api_version, x_api_version, patch_operation)
Patch a vessel
