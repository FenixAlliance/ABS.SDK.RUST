...
> models::WarehouseDtoListEnvelope get_warehouses_async(tenant_id, api_version, x_api_version, warehouse_dto_collection_query_parameters)
Get all warehouses
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**warehouse_dto_collection_query_parameters** | Option<[**WarehouseDtoCollectionQueryParameters**](WarehouseDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_warehouses_count_async(tenant_id, api_version, x_api_version, warehouse_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_warehouse_async(tenant_id, warehouse_id, api_version, x_api_version, patch_operation)
Patch a warehouse
