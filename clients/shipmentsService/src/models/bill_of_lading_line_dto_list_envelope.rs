...
pub struct BillOfLadingLineDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BillOfLadingLineDto>>>,
}

impl BillOfLadingLineDtoListEnvelope {
    pub fn new() -> BillOfLadingLineDtoListEnvelope {
