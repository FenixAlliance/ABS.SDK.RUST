...
pub struct ShippingClassDtoCollectionQueryParameters {
...
impl ShippingClassDtoCollectionQueryParameters {
    pub fn new() -> ShippingClassDtoCollectionQueryParameters {
