...
pub struct ShippingClassDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingClassDto>>>,
}

impl ShippingClassDtoListEnvelope {
    pub fn new() -> ShippingClassDtoListEnvelope {
