...
pub struct ShippingLabelDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingLabelDto>>>,
}

impl ShippingLabelDtoListEnvelope {
    pub fn new() -> ShippingLabelDtoListEnvelope {
