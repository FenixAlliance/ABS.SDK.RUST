...
pub struct BillOfLadingLineDtoEnvelope {
    ...
    pub result: Option<Box<models::BillOfLadingLineDto>>,
}

impl BillOfLadingLineDtoEnvelope {
    pub fn new() -> BillOfLadingLineDtoEnvelope {
