...
pub struct ShippingMethodDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingMethodDto>>>,
}

impl ShippingMethodDtoListEnvelope {
    pub fn new() -> ShippingMethodDtoListEnvelope {
