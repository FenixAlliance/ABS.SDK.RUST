...
pub struct ShippingRegionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingRegionDto>>>,
}

impl ShippingRegionDtoListEnvelope {
    pub fn new() -> ShippingRegionDtoListEnvelope {
