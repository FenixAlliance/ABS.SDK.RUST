...
pub struct ShippingCourierDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingCourierDto>>>,
}

impl ShippingCourierDtoListEnvelope {
    pub fn new() -> ShippingCourierDtoListEnvelope {
