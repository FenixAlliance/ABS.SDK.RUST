...
pub struct ShippingCourierDtoEnvelope {
    ...
    pub result: Option<Box<models::ShippingCourierDto>>,
}

impl ShippingCourierDtoEnvelope {
    pub fn new() -> ShippingCourierDtoEnvelope {
