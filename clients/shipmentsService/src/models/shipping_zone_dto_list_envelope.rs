...
pub struct ShippingZoneDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ShippingZoneDto>>>,
}

impl ShippingZoneDtoListEnvelope {
    pub fn new() -> ShippingZoneDtoListEnvelope {
