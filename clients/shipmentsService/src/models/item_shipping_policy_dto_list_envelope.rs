...
pub struct ItemShippingPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemShippingPolicyDto>>>,
}

impl ItemShippingPolicyDtoListEnvelope {
    pub fn new() -> ItemShippingPolicyDtoListEnvelope {
