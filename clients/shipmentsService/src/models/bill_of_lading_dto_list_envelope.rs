...
pub struct BillOfLadingDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::BillOfLadingDto>>>,
}

impl BillOfLadingDtoListEnvelope {
    pub fn new() -> BillOfLadingDtoListEnvelope {
