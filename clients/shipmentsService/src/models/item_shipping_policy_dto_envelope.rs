...
pub struct ItemShippingPolicyDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemShippingPolicyDto>>,
}

impl ItemShippingPolicyDtoEnvelope {
    pub fn new() -> ItemShippingPolicyDtoEnvelope {
