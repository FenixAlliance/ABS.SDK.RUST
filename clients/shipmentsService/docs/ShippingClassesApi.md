...
> models::ShippingClassDtoListEnvelope get_shipping_classes_async(tenant_id, api_version, x_api_version, shipping_class_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**shipping_class_dto_collection_query_parameters** | Option<[**ShippingClassDtoCollectionQueryParameters**](ShippingClassDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_shipping_classes_count_async(tenant_id, api_version, x_api_version, shipping_class_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_shipping_class_async(tenant_id, class_id, api_version, x_api_version, patch_operation)
