...
> models::ShippingMethodDtoListEnvelope get_shipping_methods_async(tenant_id, api_version, x_api_version, shipping_method_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**shipping_method_dto_collection_query_parameters** | Option<[**ShippingMethodDtoCollectionQueryParameters**](ShippingMethodDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_shipping_methods_count_async(tenant_id, api_version, x_api_version, shipping_method_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_shipping_method_async(tenant_id, method_id, api_version, x_api_version, patch_operation)
