...
> models::ShippingLabelDtoListEnvelope get_shipping_labels_async(tenant_id, api_version, x_api_version, shipping_label_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**shipping_label_dto_collection_query_parameters** | Option<[**ShippingLabelDtoCollectionQueryParameters**](ShippingLabelDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_shipping_labels_count_async(tenant_id, api_version, x_api_version, shipping_label_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_shipping_label_async(tenant_id, label_id, api_version, x_api_version, patch_operation)
