...
pub struct SalesLiteratureDtoEnvelope {
    ...
    pub result: Option<Box<models::SalesLiteratureDto>>,
}

impl SalesLiteratureDtoEnvelope {
    pub fn new() -> SalesLiteratureDtoEnvelope {
