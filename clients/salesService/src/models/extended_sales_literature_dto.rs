...
pub struct ExtendedSalesLiteratureDto {
    ...
    #[serde(rename = "salesLiteratureType", skip_serializing_if = "Option::is_none")]
    pub sales_literature_type: Option<Box<models::SalesLiteratureTypeDto>>,
    #[serde(rename = "tenant", skip_serializing_if = "Option::is_none")]
    pub tenant: Option<Box<models::TenantDto>>,
}

impl ExtendedSalesLiteratureDto {
    pub fn new() -> ExtendedSalesLiteratureDto {
