...
pub struct SalesLiteratureDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SalesLiteratureDto>>>,
}

impl SalesLiteratureDtoListEnvelope {
    pub fn new() -> SalesLiteratureDtoListEnvelope {
