...
pub struct PointOfSaleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PointOfSaleDto>>>,
}

impl PointOfSaleDtoListEnvelope {
    pub fn new() -> PointOfSaleDtoListEnvelope {
