...
pub struct LoyaltyProgramDtoCollectionQueryParameters {
...
impl LoyaltyProgramDtoCollectionQueryParameters {
    pub fn new() -> LoyaltyProgramDtoCollectionQueryParameters {
