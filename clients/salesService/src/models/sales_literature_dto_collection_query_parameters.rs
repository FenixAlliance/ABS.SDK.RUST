...
pub struct SalesLiteratureDtoCollectionQueryParameters {
...
impl SalesLiteratureDtoCollectionQueryParameters {
    pub fn new() -> SalesLiteratureDtoCollectionQueryParameters {
