...
pub struct ExtendedSalesLiteratureDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedSalesLiteratureDto>>>,
}

impl ExtendedSalesLiteratureDtoListEnvelope {
    pub fn new() -> ExtendedSalesLiteratureDtoListEnvelope {
