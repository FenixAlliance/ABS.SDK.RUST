...
pub struct LoyaltyProgramDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LoyaltyProgramDto>>>,
}

impl LoyaltyProgramDtoListEnvelope {
    pub fn new() -> LoyaltyProgramDtoListEnvelope {
