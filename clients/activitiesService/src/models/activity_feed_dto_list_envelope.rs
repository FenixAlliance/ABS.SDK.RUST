...
pub struct ActivityFeedDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ActivityFeedDto>>>,
}

impl ActivityFeedDtoListEnvelope {
    pub fn new() -> ActivityFeedDtoListEnvelope {
