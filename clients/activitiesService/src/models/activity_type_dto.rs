...
pub struct ActivityTypeDto {
    ...
    #[serde(rename = "activityRecordsCount", skip_serializing_if = "Option::is_none")]
    pub activity_records_count: Option<i32>,
}

impl ActivityTypeDto {
    pub fn new() -> ActivityTypeDto {
        ActivityTypeDto {
            id: None,
            timestamp: None,
            name: None,
