...
pub struct ActivityTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ActivityTypeDto>>>,
}

impl ActivityTypeDtoListEnvelope {
    pub fn new() -> ActivityTypeDtoListEnvelope {
