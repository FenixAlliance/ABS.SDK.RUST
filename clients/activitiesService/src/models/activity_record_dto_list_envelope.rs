...
pub struct ActivityRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ActivityRecordDto>>>,
}

impl ActivityRecordDtoListEnvelope {
    pub fn new() -> ActivityRecordDtoListEnvelope {
