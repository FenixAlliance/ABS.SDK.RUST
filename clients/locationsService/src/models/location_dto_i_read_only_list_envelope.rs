...
pub struct LocationDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LocationDto>>>,
}

impl LocationDtoIReadOnlyListEnvelope {
    pub fn new() -> LocationDtoIReadOnlyListEnvelope {
