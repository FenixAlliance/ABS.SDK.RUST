...
pub struct ExtendedQuoteDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedQuoteDto>>>,
}

impl ExtendedQuoteDtoListEnvelope {
    pub fn new() -> ExtendedQuoteDtoListEnvelope {
