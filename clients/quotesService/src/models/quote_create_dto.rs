...
pub struct QuoteCreateDto {
    ...
    #[serde(rename = "quoteLines", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub quote_lines: Option<Option<Vec<models::QuoteLineCreateDto>>>,
}

impl QuoteCreateDto {
    pub fn new() -> QuoteCreateDto {
        QuoteCreateDto {
            id: None,
            timestamp: None,
            closed: None,
