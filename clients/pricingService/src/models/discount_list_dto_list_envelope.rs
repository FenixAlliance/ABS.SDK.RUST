...
pub struct DiscountListDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::DiscountListDto>>>,
}

impl DiscountListDtoListEnvelope {
    pub fn new() -> DiscountListDtoListEnvelope {
