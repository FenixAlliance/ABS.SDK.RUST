...
pub struct RoundingPolicyDtoCollectionQueryParameters {
...
impl RoundingPolicyDtoCollectionQueryParameters {
    pub fn new() -> RoundingPolicyDtoCollectionQueryParameters {
