...
pub struct RoundingPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::RoundingPolicyDto>>>,
}

impl RoundingPolicyDtoListEnvelope {
    pub fn new() -> RoundingPolicyDtoListEnvelope {
