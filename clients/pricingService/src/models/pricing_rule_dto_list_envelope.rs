...
pub struct PricingRuleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PricingRuleDto>>>,
}

impl PricingRuleDtoListEnvelope {
    pub fn new() -> PricingRuleDtoListEnvelope {
