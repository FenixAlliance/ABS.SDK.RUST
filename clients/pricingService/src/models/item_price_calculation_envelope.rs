...
pub struct ItemPriceCalculationEnvelope {
    ...
    pub result: Option<Box<models::ItemPriceCalculation>>,
}

impl ItemPriceCalculationEnvelope {
    pub fn new() -> ItemPriceCalculationEnvelope {
