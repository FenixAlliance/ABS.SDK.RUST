...
> models::OptionDtoListEnvelope get_system_user_options(user_id, portal_id, api_version, x_api_version, option_dto_collection_query_parameters)
...
> models::Int32Envelope get_system_user_options_count(user_id, portal_id, api_version, x_api_version, option_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_system_user_option(user_id, option_id, api_version, x_api_version, patch_operation)
