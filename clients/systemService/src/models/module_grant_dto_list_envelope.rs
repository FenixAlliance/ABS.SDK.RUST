...
pub struct ModuleGrantDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ModuleGrantDto>>>,
}

impl ModuleGrantDtoListEnvelope {
    pub fn new() -> ModuleGrantDtoListEnvelope {
