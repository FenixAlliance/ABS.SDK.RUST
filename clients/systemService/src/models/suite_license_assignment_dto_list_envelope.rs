...
pub struct SuiteLicenseAssignmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SuiteLicenseAssignmentDto>>>,
}

impl SuiteLicenseAssignmentDtoListEnvelope {
    pub fn new() -> SuiteLicenseAssignmentDtoListEnvelope {
