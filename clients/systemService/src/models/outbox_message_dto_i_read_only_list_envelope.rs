...
pub struct OutboxMessageDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::OutboxMessageDto>>>,
}

impl OutboxMessageDtoIReadOnlyListEnvelope {
    pub fn new() -> OutboxMessageDtoIReadOnlyListEnvelope {
