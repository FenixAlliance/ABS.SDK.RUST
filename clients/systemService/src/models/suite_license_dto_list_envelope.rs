...
pub struct SuiteLicenseDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SuiteLicenseDto>>>,
}

impl SuiteLicenseDtoListEnvelope {
    pub fn new() -> SuiteLicenseDtoListEnvelope {
