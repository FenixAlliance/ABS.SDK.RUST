...
pub struct ApplicationPrincipalDetailDtoEnvelope {
    ...
    pub result: Option<Box<models::ApplicationPrincipalDetailDto>>,
}

impl ApplicationPrincipalDetailDtoEnvelope {
    pub fn new() -> ApplicationPrincipalDetailDtoEnvelope {
