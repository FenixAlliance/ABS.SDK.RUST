...
pub struct ApplicationPrincipalDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ApplicationPrincipalDto>>>,
}

impl ApplicationPrincipalDtoIReadOnlyListEnvelope {
    pub fn new() -> ApplicationPrincipalDtoIReadOnlyListEnvelope {
