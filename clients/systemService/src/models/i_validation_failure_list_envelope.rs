...
pub struct IValidationFailureListEnvelope {
    ...
    pub result: Option<Option<Vec<models::IValidationFailure>>>,
}

impl IValidationFailureListEnvelope {
    pub fn new() -> IValidationFailureListEnvelope {
