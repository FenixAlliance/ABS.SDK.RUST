...
pub struct ExtendedTenantDtoCollectionQueryParameters {
...
impl ExtendedTenantDtoCollectionQueryParameters {
    pub fn new() -> ExtendedTenantDtoCollectionQueryParameters {
