...
pub struct OutboxMessageDtoCollectionQueryParameters {
...
impl OutboxMessageDtoCollectionQueryParameters {
    pub fn new() -> OutboxMessageDtoCollectionQueryParameters {
