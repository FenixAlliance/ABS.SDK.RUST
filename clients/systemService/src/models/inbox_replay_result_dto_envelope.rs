...
pub struct InboxReplayResultDtoEnvelope {
    ...
    pub result: Option<Box<models::InboxReplayResultDto>>,
}

impl InboxReplayResultDtoEnvelope {
    pub fn new() -> InboxReplayResultDtoEnvelope {
