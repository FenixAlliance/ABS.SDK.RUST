...
pub struct UserAdminDetailDtoEnvelope {
    ...
    pub result: Option<Box<models::UserAdminDetailDto>>,
}

impl UserAdminDetailDtoEnvelope {
    pub fn new() -> UserAdminDetailDtoEnvelope {
