...
pub struct InboxMessageDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::InboxMessageDto>>>,
}

impl InboxMessageDtoIReadOnlyListEnvelope {
    pub fn new() -> InboxMessageDtoIReadOnlyListEnvelope {
