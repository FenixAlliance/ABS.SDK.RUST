...
pub struct GuestCartPurgeResultDtoEnvelope {
    ...
    pub result: Option<Box<models::GuestCartPurgeResultDto>>,
}

impl GuestCartPurgeResultDtoEnvelope {
    pub fn new() -> GuestCartPurgeResultDtoEnvelope {
