...
pub struct ExtendedTenantDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedTenantDto>>>,
}

impl ExtendedTenantDtoListEnvelope {
    pub fn new() -> ExtendedTenantDtoListEnvelope {
