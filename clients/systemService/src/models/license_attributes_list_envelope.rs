...
pub struct LicenseAttributesListEnvelope {
    ...
    pub result: Option<Option<Vec<serde_json::Value>>>,
}

impl LicenseAttributesListEnvelope {
    pub fn new() -> LicenseAttributesListEnvelope {
