...
pub struct LicenseValidationErrorListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LicenseValidationError>>>,
}

impl LicenseValidationErrorListEnvelope {
    pub fn new() -> LicenseValidationErrorListEnvelope {
