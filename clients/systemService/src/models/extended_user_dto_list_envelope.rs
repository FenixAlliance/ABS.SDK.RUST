...
pub struct ExtendedUserDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedUserDto>>>,
}

impl ExtendedUserDtoListEnvelope {
    pub fn new() -> ExtendedUserDtoListEnvelope {
