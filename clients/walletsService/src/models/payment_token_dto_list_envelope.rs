...
pub struct PaymentTokenDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentTokenDto>>>,
}

impl PaymentTokenDtoListEnvelope {
    pub fn new() -> PaymentTokenDtoListEnvelope {
