...
pub struct WalletWithdrawDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WalletWithdrawDto>>>,
}

impl WalletWithdrawDtoListEnvelope {
    pub fn new() -> WalletWithdrawDtoListEnvelope {
