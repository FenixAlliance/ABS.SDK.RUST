...
pub struct PaymentChargebackDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentChargebackDto>>>,
}

impl PaymentChargebackDtoListEnvelope {
    pub fn new() -> PaymentChargebackDtoListEnvelope {
