...
pub struct WalletWithdrawDtoCollectionQueryParameters {
...
impl WalletWithdrawDtoCollectionQueryParameters {
    pub fn new() -> WalletWithdrawDtoCollectionQueryParameters {
