...
pub struct PaymentRefundDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentRefundDto>>>,
}

impl PaymentRefundDtoListEnvelope {
    pub fn new() -> PaymentRefundDtoListEnvelope {
