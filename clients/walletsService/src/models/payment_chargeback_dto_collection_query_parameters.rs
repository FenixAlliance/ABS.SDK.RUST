...
pub struct PaymentChargebackDtoCollectionQueryParameters {
...
impl PaymentChargebackDtoCollectionQueryParameters {
    pub fn new() -> PaymentChargebackDtoCollectionQueryParameters {
