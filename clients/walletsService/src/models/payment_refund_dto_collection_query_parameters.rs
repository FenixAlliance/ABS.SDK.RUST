...
pub struct PaymentRefundDtoCollectionQueryParameters {
...
impl PaymentRefundDtoCollectionQueryParameters {
    pub fn new() -> PaymentRefundDtoCollectionQueryParameters {
