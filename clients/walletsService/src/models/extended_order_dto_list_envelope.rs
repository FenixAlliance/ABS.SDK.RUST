...
pub struct ExtendedOrderDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ExtendedOrderDto>>>,
}

impl ExtendedOrderDtoListEnvelope {
    pub fn new() -> ExtendedOrderDtoListEnvelope {
