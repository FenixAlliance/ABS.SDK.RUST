...
pub struct ExtendedOrderDto {
    ...
    #[serde(rename = "sellerBillingProfileId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl ExtendedOrderDto {
    pub fn new() -> ExtendedOrderDto {
        ExtendedOrderDto {
            id: None,
            timestamp: None,
            closed: None,
