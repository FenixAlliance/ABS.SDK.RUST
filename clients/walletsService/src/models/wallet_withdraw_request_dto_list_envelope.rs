...
pub struct WalletWithdrawRequestDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::WalletWithdrawRequestDto>>>,
}

impl WalletWithdrawRequestDtoListEnvelope {
    pub fn new() -> WalletWithdrawRequestDtoListEnvelope {
