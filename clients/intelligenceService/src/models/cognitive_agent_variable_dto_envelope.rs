...
pub struct CognitiveAgentVariableDtoEnvelope {
    ...
    pub result: Option<Box<models::CognitiveAgentVariableDto>>,
}

impl CognitiveAgentVariableDtoEnvelope {
    pub fn new() -> CognitiveAgentVariableDtoEnvelope {
