...
pub struct CognitiveAgentConversationDtoEnvelope {
    ...
    pub result: Option<Box<models::CognitiveAgentConversationDto>>,
}

impl CognitiveAgentConversationDtoEnvelope {
    pub fn new() -> CognitiveAgentConversationDtoEnvelope {
