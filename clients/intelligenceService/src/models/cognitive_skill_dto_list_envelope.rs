...
pub struct CognitiveSkillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveSkillDto>>>,
}

impl CognitiveSkillDtoListEnvelope {
    pub fn new() -> CognitiveSkillDtoListEnvelope {
