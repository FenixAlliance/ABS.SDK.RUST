...
pub struct CognitiveSkillDtoCollectionQueryParameters {
...
impl CognitiveSkillDtoCollectionQueryParameters {
    pub fn new() -> CognitiveSkillDtoCollectionQueryParameters {
