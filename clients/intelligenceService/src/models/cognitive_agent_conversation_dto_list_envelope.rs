...
pub struct CognitiveAgentConversationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveAgentConversationDto>>>,
}

impl CognitiveAgentConversationDtoListEnvelope {
    pub fn new() -> CognitiveAgentConversationDtoListEnvelope {
