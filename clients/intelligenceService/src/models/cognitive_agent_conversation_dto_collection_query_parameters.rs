...
pub struct CognitiveAgentConversationDtoCollectionQueryParameters {
...
impl CognitiveAgentConversationDtoCollectionQueryParameters {
    pub fn new() -> CognitiveAgentConversationDtoCollectionQueryParameters {
