...
pub struct CognitiveAgentDtoCollectionQueryParameters {
...
impl CognitiveAgentDtoCollectionQueryParameters {
    pub fn new() -> CognitiveAgentDtoCollectionQueryParameters {
