...
pub struct AiProviderDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::AiProviderDto>>>,
}

impl AiProviderDtoListEnvelope {
    pub fn new() -> AiProviderDtoListEnvelope {
