...
pub struct CognitiveAgentSkillDtoEnvelope {
    ...
    pub result: Option<Box<models::CognitiveAgentSkillDto>>,
}

impl CognitiveAgentSkillDtoEnvelope {
    pub fn new() -> CognitiveAgentSkillDtoEnvelope {
