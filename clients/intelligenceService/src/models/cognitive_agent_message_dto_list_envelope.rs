...
pub struct CognitiveAgentMessageDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveAgentMessageDto>>>,
}

impl CognitiveAgentMessageDtoListEnvelope {
    pub fn new() -> CognitiveAgentMessageDtoListEnvelope {
