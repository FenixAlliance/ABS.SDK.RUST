...
pub struct CapabilityDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CapabilityDto>>>,
}

impl CapabilityDtoListEnvelope {
    pub fn new() -> CapabilityDtoListEnvelope {
