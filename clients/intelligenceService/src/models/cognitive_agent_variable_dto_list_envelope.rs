...
pub struct CognitiveAgentVariableDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveAgentVariableDto>>>,
}

impl CognitiveAgentVariableDtoListEnvelope {
    pub fn new() -> CognitiveAgentVariableDtoListEnvelope {
