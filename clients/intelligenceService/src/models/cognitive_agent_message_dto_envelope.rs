...
pub struct CognitiveAgentMessageDtoEnvelope {
    ...
    pub result: Option<Box<models::CognitiveAgentMessageDto>>,
}

impl CognitiveAgentMessageDtoEnvelope {
    pub fn new() -> CognitiveAgentMessageDtoEnvelope {
