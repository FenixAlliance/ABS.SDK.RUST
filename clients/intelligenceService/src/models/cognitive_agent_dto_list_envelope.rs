...
pub struct CognitiveAgentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveAgentDto>>>,
}

impl CognitiveAgentDtoListEnvelope {
    pub fn new() -> CognitiveAgentDtoListEnvelope {
