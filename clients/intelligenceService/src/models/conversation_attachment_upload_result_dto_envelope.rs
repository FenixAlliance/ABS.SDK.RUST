...
pub struct ConversationAttachmentUploadResultDtoEnvelope {
    ...
    pub result: Option<Box<models::ConversationAttachmentUploadResultDto>>,
}

impl ConversationAttachmentUploadResultDtoEnvelope {
    pub fn new() -> ConversationAttachmentUploadResultDtoEnvelope {
