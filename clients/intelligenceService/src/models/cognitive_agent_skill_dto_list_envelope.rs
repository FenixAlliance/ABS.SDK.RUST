...
pub struct CognitiveAgentSkillDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CognitiveAgentSkillDto>>>,
}

impl CognitiveAgentSkillDtoListEnvelope {
    pub fn new() -> CognitiveAgentSkillDtoListEnvelope {
