...
pub struct SubscriptionDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SubscriptionDto>>>,
}

impl SubscriptionDtoIReadOnlyListEnvelope {
    pub fn new() -> SubscriptionDtoIReadOnlyListEnvelope {
