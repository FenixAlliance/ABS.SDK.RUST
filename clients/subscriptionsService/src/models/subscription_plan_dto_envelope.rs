...
pub struct SubscriptionPlanDtoEnvelope {
    ...
    pub result: Option<Box<models::SubscriptionPlanDto>>,
}

impl SubscriptionPlanDtoEnvelope {
    pub fn new() -> SubscriptionPlanDtoEnvelope {
