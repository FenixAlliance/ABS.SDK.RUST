...
pub struct SubscriptionPlanDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SubscriptionPlanDto>>>,
}

impl SubscriptionPlanDtoIReadOnlyListEnvelope {
    pub fn new() -> SubscriptionPlanDtoIReadOnlyListEnvelope {
