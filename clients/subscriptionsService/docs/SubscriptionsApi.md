...
> models::SubscriptionDtoIReadOnlyListEnvelope get_subscriptions_async(tenant_id, api_version, x_api_version, subscription_dto_collection_query_parameters)
...
> models::Int32Envelope get_subscriptions_count_async(tenant_id, api_version, x_api_version, subscription_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_subscription_async(tenant_id, subscription_id, api_version, x_api_version, patch_operation)
