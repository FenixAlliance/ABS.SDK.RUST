...
pub struct ProjectPeriodDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProjectPeriodDto>>>,
}

impl ProjectPeriodDtoListEnvelope {
    pub fn new() -> ProjectPeriodDtoListEnvelope {
