...
pub struct ProjectTimeLogDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProjectTimeLogDto>>>,
}

impl ProjectTimeLogDtoListEnvelope {
    pub fn new() -> ProjectTimeLogDtoListEnvelope {
