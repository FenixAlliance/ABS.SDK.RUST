...
pub struct TaskCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::TaskCategoryDto>>>,
}

impl TaskCategoryDtoListEnvelope {
    pub fn new() -> TaskCategoryDtoListEnvelope {
