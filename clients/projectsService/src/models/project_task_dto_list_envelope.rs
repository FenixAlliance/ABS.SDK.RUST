...
pub struct ProjectTaskDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ProjectTaskDto>>>,
}

impl ProjectTaskDtoListEnvelope {
    pub fn new() -> ProjectTaskDtoListEnvelope {
