...
> models::Int32Envelope count_item_return_policies_async(tenant_id, item_id, api_version, x_api_version, item_return_policy_dto_collection_query_parameters)
...
> models::ItemReturnPolicyDtoListEnvelope get_item_return_policies_async(tenant_id, item_id, api_version, x_api_version, item_return_policy_dto_collection_query_parameters)
