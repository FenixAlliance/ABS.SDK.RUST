...
> models::Int32Envelope count_item_categories_async(tenant_id, api_version, x_api_version, item_category_dto_collection_query_parameters)
...
> models::ItemCategoryDtoListEnvelope get_item_categories_async(tenant_id, api_version, x_api_version, item_category_dto_collection_query_parameters)
...
> patch_item_category_async(tenant_id, item_category_id, api_version, x_api_version, patch_operation)
