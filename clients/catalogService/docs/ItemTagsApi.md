...
> models::ItemTagDtoEnvelope get_item_tag_by_id_async(item_tag_id, tenant_id, api_version, x_api_version)
Get item tag by ID
...
> models::ItemTagDtoListEnvelope get_item_tags_async(tenant_id, api_version, x_api_version, item_tag_dto_collection_query_parameters)
Get all item tags
...
> patch_item_tag_async(tenant_id, item_tag_id, api_version, x_api_version, patch_operation)
Patch an item tag
