...
pub struct ItemBundleDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemBundleDto>>>,
}

impl ItemBundleDtoListEnvelope {
    pub fn new() -> ItemBundleDtoListEnvelope {
