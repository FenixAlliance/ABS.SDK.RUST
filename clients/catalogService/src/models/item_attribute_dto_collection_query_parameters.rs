...
pub struct ItemAttributeDtoCollectionQueryParameters {
...
impl ItemAttributeDtoCollectionQueryParameters {
    pub fn new() -> ItemAttributeDtoCollectionQueryParameters {
