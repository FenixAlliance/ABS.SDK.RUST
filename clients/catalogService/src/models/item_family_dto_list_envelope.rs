...
pub struct ItemFamilyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemFamilyDto>>>,
}

impl ItemFamilyDtoListEnvelope {
    pub fn new() -> ItemFamilyDtoListEnvelope {
