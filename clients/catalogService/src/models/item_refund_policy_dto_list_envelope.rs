...
pub struct ItemRefundPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemRefundPolicyDto>>>,
}

impl ItemRefundPolicyDtoListEnvelope {
    pub fn new() -> ItemRefundPolicyDtoListEnvelope {
