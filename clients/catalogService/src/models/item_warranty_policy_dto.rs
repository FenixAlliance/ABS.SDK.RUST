...
pub struct ItemWarrantyPolicyDto {
    ...
    #[serde(rename = "isExtendedWarranty", skip_serializing_if = "Option::is_none")]
    pub is_extended_warranty: Option<bool>,
    #[serde(rename = "code")]
    pub code: String,
    #[serde(rename = "title")]
    pub title: String,
...
impl ItemWarrantyPolicyDto {
    pub fn new(code: String, title: String, business_id: String) -> ItemWarrantyPolicyDto {
        ItemWarrantyPolicyDto {
            id: None,
            timestamp: None,
            is_extended_warranty: None,
            code,
            title,
            description: None,
            is_free: None,
