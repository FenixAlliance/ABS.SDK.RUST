...
pub struct ItemAttachmentDtoCollectionQueryParameters {
...
impl ItemAttachmentDtoCollectionQueryParameters {
    pub fn new() -> ItemAttachmentDtoCollectionQueryParameters {
