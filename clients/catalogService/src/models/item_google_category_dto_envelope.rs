...
pub struct ItemGoogleCategoryDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemGoogleCategoryDto>>,
}

impl ItemGoogleCategoryDtoEnvelope {
    pub fn new() -> ItemGoogleCategoryDtoEnvelope {
