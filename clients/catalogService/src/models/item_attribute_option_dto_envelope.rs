...
pub struct ItemAttributeOptionDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemAttributeOptionDto>>,
}

impl ItemAttributeOptionDtoEnvelope {
    pub fn new() -> ItemAttributeOptionDtoEnvelope {
