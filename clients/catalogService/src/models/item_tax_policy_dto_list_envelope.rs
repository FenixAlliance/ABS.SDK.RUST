...
pub struct ItemTaxPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemTaxPolicyDto>>>,
}

impl ItemTaxPolicyDtoListEnvelope {
    pub fn new() -> ItemTaxPolicyDtoListEnvelope {
