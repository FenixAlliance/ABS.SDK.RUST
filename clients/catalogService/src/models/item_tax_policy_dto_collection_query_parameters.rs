...
pub struct ItemTaxPolicyDtoCollectionQueryParameters {
...
impl ItemTaxPolicyDtoCollectionQueryParameters {
    pub fn new() -> ItemTaxPolicyDtoCollectionQueryParameters {
