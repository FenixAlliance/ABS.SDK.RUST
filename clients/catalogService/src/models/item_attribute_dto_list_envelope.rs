...
pub struct ItemAttributeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemAttributeDto>>>,
}

impl ItemAttributeDtoListEnvelope {
    pub fn new() -> ItemAttributeDtoListEnvelope {
