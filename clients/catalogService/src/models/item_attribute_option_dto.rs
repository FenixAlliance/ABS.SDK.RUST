...
pub struct ItemAttributeOptionDto {
    ...
    #[serde(rename = "itemAttributeId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub item_attribute_id: Option<Option<String>>,
...
impl ItemAttributeOptionDto {
    pub fn new() -> ItemAttributeOptionDto {
