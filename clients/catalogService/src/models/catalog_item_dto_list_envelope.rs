...
pub struct CatalogItemDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CatalogItemDto>>>,
}

impl CatalogItemDtoListEnvelope {
    pub fn new() -> CatalogItemDtoListEnvelope {
