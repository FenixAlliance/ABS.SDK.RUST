...
pub struct ItemRefundPolicyDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemRefundPolicyDto>>,
}

impl ItemRefundPolicyDtoEnvelope {
    pub fn new() -> ItemRefundPolicyDtoEnvelope {
