...
pub struct ItemCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemCategoryDto>>>,
}

impl ItemCategoryDtoListEnvelope {
    pub fn new() -> ItemCategoryDtoListEnvelope {
