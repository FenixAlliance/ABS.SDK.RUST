...
pub struct ItemWarrantyPolicyDtoEnvelope {
    ...
    pub result: Option<Box<models::ItemWarrantyPolicyDto>>,
}

impl ItemWarrantyPolicyDtoEnvelope {
    pub fn new() -> ItemWarrantyPolicyDtoEnvelope {
