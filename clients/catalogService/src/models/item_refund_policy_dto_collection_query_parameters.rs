...
pub struct ItemRefundPolicyDtoCollectionQueryParameters {
...
impl ItemRefundPolicyDtoCollectionQueryParameters {
    pub fn new() -> ItemRefundPolicyDtoCollectionQueryParameters {
