...
pub struct ItemAttachmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemAttachmentDto>>>,
}

impl ItemAttachmentDtoListEnvelope {
    pub fn new() -> ItemAttachmentDtoListEnvelope {
