...
pub struct ItemReturnPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemReturnPolicyDto>>>,
}

impl ItemReturnPolicyDtoListEnvelope {
    pub fn new() -> ItemReturnPolicyDtoListEnvelope {
