...
pub struct ItemReviewDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemReviewDto>>>,
}

impl ItemReviewDtoListEnvelope {
    pub fn new() -> ItemReviewDtoListEnvelope {
