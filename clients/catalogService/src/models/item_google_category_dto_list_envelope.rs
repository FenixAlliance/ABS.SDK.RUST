...
pub struct ItemGoogleCategoryDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemGoogleCategoryDto>>>,
}

impl ItemGoogleCategoryDtoListEnvelope {
    pub fn new() -> ItemGoogleCategoryDtoListEnvelope {
