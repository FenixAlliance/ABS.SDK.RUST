...
pub struct ItemQuestionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemQuestionDto>>>,
}

impl ItemQuestionDtoListEnvelope {
    pub fn new() -> ItemQuestionDtoListEnvelope {
