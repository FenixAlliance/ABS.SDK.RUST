...
pub struct ItemAttributeOptionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemAttributeOptionDto>>>,
}

impl ItemAttributeOptionDtoListEnvelope {
    pub fn new() -> ItemAttributeOptionDtoListEnvelope {
