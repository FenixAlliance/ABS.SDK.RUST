...
pub struct ItemWarrantyPolicyDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ItemWarrantyPolicyDto>>>,
}

impl ItemWarrantyPolicyDtoListEnvelope {
    pub fn new() -> ItemWarrantyPolicyDtoListEnvelope {
