...
pub struct LicenseAttributeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LicenseAttributeDto>>>,
}

impl LicenseAttributeDtoListEnvelope {
    pub fn new() -> LicenseAttributeDtoListEnvelope {
