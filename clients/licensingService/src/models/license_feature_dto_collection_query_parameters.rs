...
pub struct LicenseFeatureDtoCollectionQueryParameters {
...
impl LicenseFeatureDtoCollectionQueryParameters {
    pub fn new() -> LicenseFeatureDtoCollectionQueryParameters {
