...
pub struct LicensingCertificateDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LicensingCertificateDto>>>,
}

impl LicensingCertificateDtoListEnvelope {
    pub fn new() -> LicensingCertificateDtoListEnvelope {
