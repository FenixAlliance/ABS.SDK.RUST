...
pub struct LicenseTypeDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LicenseTypeDto>>>,
}

impl LicenseTypeDtoListEnvelope {
    pub fn new() -> LicenseTypeDtoListEnvelope {
