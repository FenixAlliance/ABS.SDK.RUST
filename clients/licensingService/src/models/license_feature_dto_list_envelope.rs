...
pub struct LicenseFeatureDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::LicenseFeatureDto>>>,
}

impl LicenseFeatureDtoListEnvelope {
    pub fn new() -> LicenseFeatureDtoListEnvelope {
