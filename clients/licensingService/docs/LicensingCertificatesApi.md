...
> models::LicensingCertificateDtoListEnvelope get_licensing_certificates_async(tenant_id, api_version, x_api_version, licensing_certificate_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**licensing_certificate_dto_collection_query_parameters** | Option<[**LicensingCertificateDtoCollectionQueryParameters**](LicensingCertificateDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_licensing_certificates_count_async(tenant_id, api_version, x_api_version, licensing_certificate_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_licensing_certificate_async(tenant_id, id, api_version, x_api_version, patch_operation)
