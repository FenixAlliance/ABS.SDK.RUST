...
> models::LicenseFeatureDtoListEnvelope get_license_features_async(tenant_id, api_version, x_api_version, license_feature_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**license_feature_dto_collection_query_parameters** | Option<[**LicenseFeatureDtoCollectionQueryParameters**](LicenseFeatureDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_license_features_count_async(tenant_id, api_version, x_api_version, license_feature_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_license_feature_async(tenant_id, id, api_version, x_api_version, patch_operation)
