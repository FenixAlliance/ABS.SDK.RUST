...
pub struct PaymentModeDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentModeDto>>>,
}

impl PaymentModeDtoIReadOnlyListEnvelope {
    pub fn new() -> PaymentModeDtoIReadOnlyListEnvelope {
