...
pub struct PaymentMethodDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentMethodDto>>>,
}

impl PaymentMethodDtoIReadOnlyListEnvelope {
    pub fn new() -> PaymentMethodDtoIReadOnlyListEnvelope {
