...
pub struct PaymentTermDtoIReadOnlyListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentTermDto>>>,
}

impl PaymentTermDtoIReadOnlyListEnvelope {
    pub fn new() -> PaymentTermDtoIReadOnlyListEnvelope {
