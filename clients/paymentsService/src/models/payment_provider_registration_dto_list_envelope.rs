...
pub struct PaymentProviderRegistrationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PaymentProviderRegistrationDto>>>,
}

impl PaymentProviderRegistrationDtoListEnvelope {
    pub fn new() -> PaymentProviderRegistrationDtoListEnvelope {
