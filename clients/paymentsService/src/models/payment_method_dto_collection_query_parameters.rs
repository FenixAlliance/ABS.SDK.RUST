...
pub struct PaymentMethodDtoCollectionQueryParameters {
...
impl PaymentMethodDtoCollectionQueryParameters {
    pub fn new() -> PaymentMethodDtoCollectionQueryParameters {
