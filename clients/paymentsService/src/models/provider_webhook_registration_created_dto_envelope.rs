...
pub struct ProviderWebhookRegistrationCreatedDtoEnvelope {
    ...
    pub result: Option<Box<models::ProviderWebhookRegistrationCreatedDto>>,
}

impl ProviderWebhookRegistrationCreatedDtoEnvelope {
    pub fn new() -> ProviderWebhookRegistrationCreatedDtoEnvelope {
