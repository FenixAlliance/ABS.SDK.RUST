...
> models::PaymentModeDtoIReadOnlyListEnvelope get_payment_modes_async(tenant_id, api_version, x_api_version, payment_mode_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**payment_mode_dto_collection_query_parameters** | Option<[**PaymentModeDtoCollectionQueryParameters**](PaymentModeDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_payment_modes_count_async(tenant_id, api_version, x_api_version, payment_mode_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_payment_mode_async(tenant_id, payment_mode_id, api_version, x_api_version, patch_operation)
