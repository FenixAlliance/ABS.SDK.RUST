...
> models::PaymentMethodDtoIReadOnlyListEnvelope get_payment_methods_async(tenant_id, api_version, x_api_version, payment_method_dto_collection_query_parameters)
...
**api_version** | Option<**String**> |  |  |
**x_api_version** | Option<**String**> |  |  |
**payment_method_dto_collection_query_parameters** | Option<[**PaymentMethodDtoCollectionQueryParameters**](PaymentMethodDtoCollectionQueryParameters.md)> |  |  |
...
> models::Int32Envelope get_payment_methods_count_async(tenant_id, api_version, x_api_version, payment_method_dto_collection_query_parameters)
...
> models::EmptyEnvelope patch_payment_method_async(tenant_id, payment_method_id, api_version, x_api_version, patch_operation)
