...
> models::SkillDtoListEnvelope get_skills_async(tenant_id, api_version, x_api_version)
Get skills
...
> models::Int32Envelope get_skills_count_async(tenant_id, api_version, x_api_version)
Count skills
...
> models::EmptyEnvelope patch_skill_async(tenant_id, skill_id, api_version, x_api_version, operation)
Patch a skill
