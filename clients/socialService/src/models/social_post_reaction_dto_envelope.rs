...
pub struct SocialPostReactionDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialPostReactionDto>>,
}

impl SocialPostReactionDtoEnvelope {
    pub fn new() -> SocialPostReactionDtoEnvelope {
