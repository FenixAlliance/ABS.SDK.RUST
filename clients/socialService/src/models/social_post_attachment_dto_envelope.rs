...
pub struct SocialPostAttachmentDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialPostAttachmentDto>>,
}

impl SocialPostAttachmentDtoEnvelope {
    pub fn new() -> SocialPostAttachmentDtoEnvelope {
