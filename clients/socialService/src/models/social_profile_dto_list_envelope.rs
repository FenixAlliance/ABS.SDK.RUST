...
pub struct SocialProfileDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialProfileDto>>>,
}

impl SocialProfileDtoListEnvelope {
    pub fn new() -> SocialProfileDtoListEnvelope {
