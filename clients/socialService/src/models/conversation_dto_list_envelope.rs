...
pub struct ConversationDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::ConversationDto>>>,
}

impl ConversationDtoListEnvelope {
    pub fn new() -> ConversationDtoListEnvelope {
