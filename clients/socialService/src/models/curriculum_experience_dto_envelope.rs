...
pub struct CurriculumExperienceDtoEnvelope {
    ...
    pub result: Option<Box<models::CurriculumExperienceDto>>,
}

impl CurriculumExperienceDtoEnvelope {
    pub fn new() -> CurriculumExperienceDtoEnvelope {
