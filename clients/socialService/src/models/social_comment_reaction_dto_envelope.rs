...
pub struct SocialCommentReactionDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialCommentReactionDto>>,
}

impl SocialCommentReactionDtoEnvelope {
    pub fn new() -> SocialCommentReactionDtoEnvelope {
