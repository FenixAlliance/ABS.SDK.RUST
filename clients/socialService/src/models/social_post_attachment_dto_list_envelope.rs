...
pub struct SocialPostAttachmentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialPostAttachmentDto>>>,
}

impl SocialPostAttachmentDtoListEnvelope {
    pub fn new() -> SocialPostAttachmentDtoListEnvelope {
