...
pub struct SocialPostCommentDtoEnvelope {
    ...
    pub result: Option<Box<models::SocialPostCommentDto>>,
}

impl SocialPostCommentDtoEnvelope {
    pub fn new() -> SocialPostCommentDtoEnvelope {
