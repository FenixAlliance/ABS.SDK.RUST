...
pub struct SocialCommentReactionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialCommentReactionDto>>>,
}

impl SocialCommentReactionDtoListEnvelope {
    pub fn new() -> SocialCommentReactionDtoListEnvelope {
