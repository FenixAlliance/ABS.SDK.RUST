...
pub struct PrivateMessageDtoCollectionQueryParameters {
...
impl PrivateMessageDtoCollectionQueryParameters {
    pub fn new() -> PrivateMessageDtoCollectionQueryParameters {
