...
pub struct SocialPostDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialPostDto>>>,
}

impl SocialPostDtoListEnvelope {
    pub fn new() -> SocialPostDtoListEnvelope {
