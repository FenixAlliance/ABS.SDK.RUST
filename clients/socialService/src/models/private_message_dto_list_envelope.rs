...
pub struct PrivateMessageDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::PrivateMessageDto>>>,
}

impl PrivateMessageDtoListEnvelope {
    pub fn new() -> PrivateMessageDtoListEnvelope {
