...
pub struct CurriculumExperienceDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CurriculumExperienceDto>>>,
}

impl CurriculumExperienceDtoListEnvelope {
    pub fn new() -> CurriculumExperienceDtoListEnvelope {
