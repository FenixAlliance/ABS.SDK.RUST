...
pub struct SocialReactionDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialReactionDto>>>,
}

impl SocialReactionDtoListEnvelope {
    pub fn new() -> SocialReactionDtoListEnvelope {
