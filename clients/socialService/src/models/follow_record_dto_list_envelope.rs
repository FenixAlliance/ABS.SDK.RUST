...
pub struct FollowRecordDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::FollowRecordDto>>>,
}

impl FollowRecordDtoListEnvelope {
    pub fn new() -> FollowRecordDtoListEnvelope {
