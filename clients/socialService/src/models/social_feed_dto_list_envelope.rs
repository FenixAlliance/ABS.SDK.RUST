...
pub struct SocialFeedDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialFeedDto>>>,
}

impl SocialFeedDtoListEnvelope {
    pub fn new() -> SocialFeedDtoListEnvelope {
