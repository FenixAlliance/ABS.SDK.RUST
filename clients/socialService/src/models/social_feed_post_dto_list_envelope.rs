...
pub struct SocialFeedPostDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialFeedPostDto>>>,
}

impl SocialFeedPostDtoListEnvelope {
    pub fn new() -> SocialFeedPostDtoListEnvelope {
