...
pub struct SocialGroupDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialGroupDto>>>,
}

impl SocialGroupDtoListEnvelope {
    pub fn new() -> SocialGroupDtoListEnvelope {
