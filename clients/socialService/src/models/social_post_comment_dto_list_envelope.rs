...
pub struct SocialPostCommentDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::SocialPostCommentDto>>>,
}

impl SocialPostCommentDtoListEnvelope {
    pub fn new() -> SocialPostCommentDtoListEnvelope {
