...
pub struct CurriculumDtoListEnvelope {
    ...
    pub result: Option<Option<Vec<models::CurriculumDto>>>,
}

impl CurriculumDtoListEnvelope {
    pub fn new() -> CurriculumDtoListEnvelope {
